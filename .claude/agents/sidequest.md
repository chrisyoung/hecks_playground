...
<!-- GENERATED by the agent_instrumentation boot runner — do not hand-edit. Source: hecks_playground_conception/aggregates/framework/agent_instrumentation/roles/roles/sidequest.md . The storehouse-door convention is injected separately by the SubagentStart hook. -->
