#!/usr/bin/env python3
"""Seed Autumn's body — copy the full hecks_playground_conception to Modal volume.
...
HECKS_PLAYGROUND = "/Users/christopheryoung/Projects/hecks_playground"
DEST = "/data/hecks_playground"
...
def seed(project_tar: bytes):
    ...
    # Count what we got
    conception = os.path.join(DEST, "hecks_playground_conception")
...
def main():
    ...
    print("📦 Packing hecks_playground_conception...")

    buf = io.BytesIO()
    with tarfile.open(fileobj=buf, mode="w:gz") as tar:
        for root, dirs, files in os.walk(HECKS_PLAYGROUND):
            ...
            for f in files:
                ...
                arcname = os.path.relpath(filepath, HECKS_PLAYGROUND)
    ...
    print(f"\n🍂 Autumn's body seeded — full hecks_playground repo:")
