...
The hecks_playground repo is cloned to the volume. storehouse runs against it.
...
# Image: the full hecks_playground project with storehouse compiled
body_image = (
    ...
    .add_local_dir(
        "/Users/christopheryoung/Projects/hecks_playground/rust",
...
# === Constants ===
PROJECT = "/data/hecks_playground/hecks_playground_conception"
HL = "storehouse"
...
# ===================================================================
# Seed: copy the full hecks_playground_conception to the volume
# ===================================================================
