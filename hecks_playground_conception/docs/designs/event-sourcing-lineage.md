...
### Today (verified)
Ruby is a SECOND runtime : its own dispatch (`ruby/hecks_playground/mixins/command/dispatch.rb`),
its own event bus (`ruby/hecks_playground_multidomain/filtered_event_bus.rb`), its own
