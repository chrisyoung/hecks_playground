...
#
# This is an optional integration layer -- only needed when using HecksPlayground
...
require "hecks_playground/chapters/rails"
HecksPlayground::Chapters.load_chapter(
  HecksPlayground::Rails,
  base_dir: File.expand_path("active_hecks_playground", __dir__)
)
