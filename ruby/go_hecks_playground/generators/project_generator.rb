...
module GoHecks
  class ProjectGenerator
    ...
    def generate_server
      ...
      # Path resolution: try hecksties first (monorepo layout), then legacy hecks_playground_runtime
      erb_base = File.expand_path("../../../../../hecksties/lib/hecks_playground/extensions/web_explorer/views", __dir__)
      erb_base = File.expand_path("../../../../hecks_playground_runtime/lib/hecks_playground/extensions/web_explorer/views", __dir__) unless Dir.exist?(erb_base)
      erb_dir = erb_base
