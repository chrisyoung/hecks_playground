...
#
module GoHecks
  class ServerGenerator < HecksPlayground::Generator
    module HtmlRoutes
      private
      ...
      def html_routes
        ...
        @domain.aggregates.each do |agg|
          ...
          attrs = agg.attributes.reject { |a|
            HecksPlayground::Utils::RESERVED_AGGREGATE_ATTRS.include?(a.name.to_s) || !a.visible?
          }
          ...
          @domain.aggregates.each do |other|
            ...
            other.commands.each do |cmd|
              ...
              has_ref = (cmd.references || []).any? { |r| HecksPlayground::Utils.underscore(r.type) == snake }
