# HecksPlayground::Adapters::PStoreAdapter
#
...
# database server.
#
#   app = HecksPlayground::Runtime.new(domain) do
#     adapter "Pizza", HecksPlayground::Adapters::PStoreAdapter.new("tmp/pizzas.pstore")
#   end
#
require "pstore"
  ...
  module Adapters
    class PStoreAdapter
      ...
      def match?(actual, expected)
        if expected.is_a?(HecksPlayground::Querying::Operators::Operator)
