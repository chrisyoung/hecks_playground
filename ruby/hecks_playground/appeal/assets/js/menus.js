...
//
// All menu actions dispatch through HecksPlayground.dispatch() to the domain.
...
(function () {
  ...
  function dispatch(aggregate, command, args) {
    if (window.HecksPlayground && window.HecksPlayground.dispatch) {
      return window.HecksPlayground.dispatch(aggregate, command, args || {});
