# HecksPlayground::Behaviors::FixturesLoader
#
...
#
# The file, if any, is parsed via the `HecksPlayground.fixtures` DSL (same
...
module HecksPlayground
  module Behaviors
    module FixturesLoader
      ...
      # Parse a .fixtures file via the HecksPlayground.fixtures DSL and return the
      ...
      def parse_file(path)
        ...
        prev = HecksPlayground.last_fixtures_file
        HecksPlayground.last_fixtures_file = nil
        Kernel.load(path)
        HecksPlayground.last_fixtures_file
      ensure
        HecksPlayground.last_fixtures_file = prev
      end
