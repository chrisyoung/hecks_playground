# HecksPlayground::Behaviors::Interpreter
#
  ...
  module Behaviors
    module Interpreter
      ...
      def resolve_expr(expr, state, attrs)
        ...
        # runners. HECKS_PLAYGROUND_RAND_SEED env var overrides RNG for tests :
        ...
        if expr.start_with?("rand_below(") && expr.end_with?(")")
          ...
          if (seed = ENV["HECKS_PLAYGROUND_RAND_SEED"]) && Integer(seed, exception: false)
