...
#
#   result = HecksPlayground::AstExtractor.extract_file("examples/pizzas/PizzasBluebook")
#   result[:name]        # => "Pizzas"
#   result[:aggregates]  # => [{ name: "Pizza", attributes: [...], ... }, ...]
#
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Bluebook::AstParagraph,
...
module HecksPlayground
  class AstExtractor
    ...
    #
    # @param source [String] Ruby source code containing a HecksPlayground.bluebook block
    ...
    def domain_call?(node)
      ...
      receiver.type == :CONST && receiver.children[0] == :HecksPlayground && method_name == :domain
    end
