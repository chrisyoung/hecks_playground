# HecksPlayground::ContextMapGenerator
#
...
#   HecksPlayground::ContextMapGenerator.new(domains).generate
#   # => "graph TD\n    subgraph Pizzas\n    ..."
#
#   HecksPlayground::ContextMapGenerator.new(domains).generate_text
#   # => "Bounded Contexts:\n  [Pizzas] ..."
#
class HecksPlayground::ContextMapGenerator
  include HecksTemplating::NamingHelpers

  # @param domains [Array<HecksPlayground::BluebookModel::Structure::Domain>] loaded domain IRs
