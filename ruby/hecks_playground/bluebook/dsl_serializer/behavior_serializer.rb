module HecksPlayground
  class DslSerializer
    # HecksPlayground::DslSerializer::BehaviorSerializer
    #
    ...
    module BehaviorSerializer
      ...
      def serialize_subscribers(subscribers)
        subscribers.flat_map do |sub|
          ...
          lines << "      #{HecksPlayground::Utils.block_source(sub.block)}" if sub.block
          lines << "    end"
        end
      end
      ...
      def append_translate(lines, pol, indent)
        ...
        body = HecksPlayground::Utils.block_source(pol.translate)
      ...
      def append_condition(lines, pol, indent)
        ...
        body = HecksPlayground::Utils.block_source(pol.condition)
