  # HecksPlayground::EventStormImporter
  #
  ...
  # content patterns.
  #
  # Extended onto the top-level HecksPlayground module to provide +HecksPlayground.from_event_storm+.
  ...
  #
  #   HecksPlayground.from_event_storm("event_storm.yml")
  #   HecksPlayground.from_event_storm("event_storm.md", name: "Pizzas")
  #
