  ...
  #
  #   generator = HecksPlayground::FlowGenerator.new(domain)
  #   puts generator.generate_text
  #   puts generator.generate_mermaid
  #
module HecksPlayground
  class FlowGenerator
    # @param domain [HecksPlayground::BluebookModel::Structure::Domain] the domain to analyze
    ...
    def humanize_command(name)
      HecksPlayground::Utils.humanize(name)
    end
