HecksPlayground::Chapters.load_aggregates(
  ...
  # HecksPlayground::DomainGlossary
  #
  ...
  #
  #   HecksPlayground::DomainGlossary.new(domain).generate  # => Array<String> of lines
  #   HecksPlayground::DomainGlossary.new(domain).print      # prints to stdout
...
module HecksPlayground
  class BluebookGlossary
    ...
    # @param domain [HecksPlayground::BluebookModel::Domain] the domain IR to describe
    ...
    #
    # @param agg [HecksPlayground::BluebookModel::Aggregate] the aggregate to describe
