module HecksPlayground
  class BluebookGlossary
    # HecksPlayground::DomainGlossary::StatementBuilders
    #
    ...
    module StatementBuilders
      ...
      # @param attr [HecksPlayground::BluebookModel::Attribute] the attribute to describe
      ...
      # @param cmd [HecksPlayground::BluebookModel::Command] the command to describe
      # @param event [HecksPlayground::BluebookModel::Event, nil] the resulting event, or nil
      ...
      # @param pol [HecksPlayground::BluebookModel::Policy] the policy to describe
