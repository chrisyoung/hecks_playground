  # HecksPlayground::BluebookInspector
  #
  ...
  # Extended onto the HecksPlayground module so these are available as top-level
  ...
  # loaded domains.
  #
  #   HecksPlayground.commands   # => ["Pizza.CreatePizza(name: String) -> CreatedPizza"]
  #   HecksPlayground.queries    # => ["Pizza.FindByName"]
  #   HecksPlayground.policies   # => ["Pizza: CreatedPizza -> NotifyKitchen"]
  #   HecksPlayground.aggregates # => ["Pizza (name: String, size: String)"]
  #   HecksPlayground.glossary   # prints full glossary to stdout
  #
module HecksPlayground
  module BluebookInspector
    ...
    #
    # @return [Array<HecksPlayground::BluebookModel::Aggregate>] all aggregates
    def each_aggregate
