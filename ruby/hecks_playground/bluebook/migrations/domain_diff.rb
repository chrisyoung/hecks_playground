HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Bluebook::MigrationsParagraph,
  base_dir: File.expand_path("domain_diff", __dir__)
)

module HecksPlayground
  module Migrations
    # HecksPlayground::Migrations::BluebookDiff
    #
    ...
    #
    #   old_domain = HecksPlayground.bluebook("Pizzas") { ... }
    #   new_domain = HecksPlayground.bluebook("Pizzas") { ... }
    ...
    #
    # @param old_domain [HecksPlayground::BluebookModel::Domain, nil] the previous domain version (nil for first build)
    # @param new_domain [HecksPlayground::BluebookModel::Domain] the current domain version
    # @return [Array<Change>] list of detected changes
    def self.call(old_domain, new_domain)
      new(old_domain, new_domain).changes
    end

    # @param old_domain [HecksPlayground::BluebookModel::Domain, nil] the previous domain version
    # @param new_domain [HecksPlayground::BluebookModel::Domain] the current domain version
    ...
    #
    # @param old_agg [HecksPlayground::BluebookModel::Aggregate] the previous aggregate version
    # @param new_agg [HecksPlayground::BluebookModel::Aggregate] the current aggregate version
