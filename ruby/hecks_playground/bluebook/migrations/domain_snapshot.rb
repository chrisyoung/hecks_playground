module HecksPlayground
  module Migrations
    # HecksPlayground::Migrations::DomainSnapshot
    #
    ...
    # when evaluated. The default location is +.hecks_playground_domain_snapshot.rb+
    # in the project root.
    #
    #   DomainSnapshot.save(domain, path: ".hecks_playground_domain_snapshot.rb")
    #   old_domain = DomainSnapshot.load(path: ".hecks_playground_domain_snapshot.rb")
    #
    class BluebookSnapshot

    # Default file path for the snapshot file, relative to the project root.
    DEFAULT_PATH = ".hecks_playground_domain_snapshot.rb"
    ...
    # the snapshot and returns the resulting domain via +HecksPlayground.last_domain+.
