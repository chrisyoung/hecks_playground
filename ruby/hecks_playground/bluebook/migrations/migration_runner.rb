module HecksPlayground
  module Migrations
    # HecksPlayground::Migrations::MigrationRunner
    #
    # Executes pending SQL migration files from db/hecks_playground_migrate/ against a
    # database connection. Tracks applied migrations in a hecks_playground_schema_migrations
    ...
    #   (default "db/hecks_playground_migrate")
    def initialize(connection:, migration_dir: "db/hecks_playground_migrate")
    ...
    # @raise [HecksPlayground::MigrationError] if any migration fails to execute
    def run_all
      results = []
      pending.each do |file|
        ...
        begin
          ...
          raise HecksPlayground::MigrationError, "Migration #{name} failed: #{e.message}"
        end
      end
      results
    end
