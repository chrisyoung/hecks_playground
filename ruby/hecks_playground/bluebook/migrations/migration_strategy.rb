module HecksPlayground
  module Migrations
    # HecksPlayground::Migrations::MigrationStrategy
    #
    ...
    #
    #   class RedisMigrationStrategy < HecksPlayground::Migrations::MigrationStrategy
    ...
    #
    #   HecksPlayground::Migrations::MigrationStrategy.register(:redis, RedisMigrationStrategy)
    #
