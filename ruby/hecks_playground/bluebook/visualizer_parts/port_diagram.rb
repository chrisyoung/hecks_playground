# HecksPlayground::DomainVisualizer::PortDiagram
#
...
#    Extension metadata is read from HecksPlayground.extension_meta when available; an
...
module HecksPlayground
  class BluebookVisualizer
    module PortDiagram
      ...
      #   HecksPlayground.extension_meta if available
      ...
      def resolve_extension_meta(explicit)
        ...
        return HecksPlayground.extension_meta if defined?(HecksPlayground.extension_meta) && HecksPlayground.extension_meta.any?
