module HecksPlayground
  module BluebookModel
    ...
    # HecksPlayground::BluebookModel::Behavior::BluebookEvent
    #
    ...
    class BluebookEvent
      ...
      # @return [Array<HecksPlayground::BluebookModel::Structure::Attribute>] data attributes
      ...
      # @param attributes [Array<HecksPlayground::BluebookModel::Structure::Attribute>] data
      #   attributes carried by this event. Defaults to an empty array.
      # @param references [Array<HecksPlayground::BluebookModel::Structure::Reference>] references
