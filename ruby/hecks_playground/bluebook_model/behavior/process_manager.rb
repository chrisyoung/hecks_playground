# HecksPlayground::BluebookModel::Behavior::ProcessManager
#
...
# +HecksPlayground::DSL::ProcessManagerBuilder+ in the DSL. Phase 1 of the dream-study
...
#
# [antibody-exempt: ruby/hecks_playground/bluebook_model/behavior/process_manager.rb —
  ...
  module BluebookModel
    module Behavior
      class ProcessManager
        # HecksPlayground::BluebookModel::Behavior::ProcessManager::Handler
        #
        # One on-event handler within a process manager. Mirrors the runtime
        # +HecksPlayground::EventSourcing::ProcessManager::Handler+ shape, minus
        ...
        # HecksPlayground::BluebookModel::Behavior::ProcessManager::DispatchSpec
        #
        ...
        # HecksPlayground::BluebookModel::Behavior::ProcessManager::ForEachSpec
        #
        ...
        #
        # +source_context+   — optional bluebook context (HecksPlayground.bluebook
        ...
        # HecksPlayground::BluebookModel::Behavior::ProcessManager::ValueSpec
        #
