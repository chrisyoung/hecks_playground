# [antibody-exempt: ruby/hecks_playground/bluebook_model/behavior/query.rb — kernel-
...
module HecksPlayground
  module BluebookModel
    ...
    # HecksPlayground::BluebookModel::Behavior::Query
    #
    ...
    class Query
      ...
      def record_block_structure!
        ...
        # nothing.
        raise HecksPlayground::BluebookLoadError,
              "query #{@name.inspect} could not be read : #{e.class} — #{e.message}"
      end
    end

    # HecksPlayground::BluebookModel::Behavior::QueryRecorder
    #
