module HecksPlayground
  module BluebookModel
    ...
    # HecksPlayground::BluebookModel::Structure::Aggregate
    #
    # Intermediate representation of a DDD aggregate -- the core building block
    # of a HecksPlayground domain. Groups a root entity with its value objects, commands,
    ...
    class Aggregate
      ...
      # @return [String, nil] superclass for class-kind aggregates (e.g., "HecksPlayground::Generator")
