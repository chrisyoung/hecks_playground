module HecksPlayground
  module BluebookModel
    ...
    # HecksPlayground::BluebookModel::Structure::Entity
    #
    ...
    # include HecksPlayground::Model, which provides identity, attribute accessors, and
    # invariant enforcement.
    #
    # Part of the BluebookModel IR layer. Built by EntityBuilder and consumed by
    # EntityGenerator to produce classes that include HecksPlayground::Model.
    #
    #   entity = Entity.new(
    #     name: "LedgerEntry",
