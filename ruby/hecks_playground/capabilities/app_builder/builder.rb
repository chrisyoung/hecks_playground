# HecksPlayground::Capabilities::AppBuilder::Builder
#
...
#   # => { file: "hecks_playground/user_auth.bluebook", content: "..." }
#
    ...
    module AppBuilder
      class Builder
        ...
        def build(additions)
          ...
          write_path = File.join(find_hecks_playground_dir, filename)
        ...
        def generate_bluebook(additions)
          ...
          lines = ["HecksPlayground.bluebook \"#{domain_name}\" do"]
        ...
        def find_hecks_playground_dir
          root = @runtime.respond_to?(:root) ? @runtime.root : Dir.pwd
          dir = File.join(root, "hecks_playground")
