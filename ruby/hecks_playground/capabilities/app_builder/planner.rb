# HecksPlayground::Capabilities::AppBuilder::Planner
#
  ...
  module Capabilities
    module AppBuilder
      class Planner
        ...
        def resolve_adapter
          return nil unless defined?(HecksPlayground::Extensions::ClaudeCliAdapter)
          ...
          if config[:api_key] && !config[:api_key].to_s.empty?
            HecksPlayground::Extensions::ClaudeAdapter.new(api_key: config[:api_key], model: model, max_tokens: 4096)
          else
            HecksPlayground::Extensions::ClaudeCliAdapter.new(model: model, max_tokens: 4096)
          end
        rescue
          nil
        end
