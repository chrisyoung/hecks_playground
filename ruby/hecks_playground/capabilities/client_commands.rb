# HecksPlayground::Capabilities::ClientCommands
#
...
#
# Serves the generated JS at /hecks_playground/client.js and mounts a docs
# endpoint at /hecks_playground/docs showing the routing table.
#
  ...
  module Capabilities
    ...
    module ClientCommands
      ...
      def self.mount_routes(runtime)
        ...
        adapter.mount("/hecks_playground/client.js") do |_req, res|
          res["Content-Type"] = "application/javascript"
          res.body = js
        end

        adapter.mount("/hecks_playground/docs") do |_req, res|
      ...
      def self.generate_docs(runtime)
        ...
        domain.aggregates.each do |agg|
          ...
          agg.commands.each do |cmd|
            ...
            lines << "<p><code>HecksPlayground.dispatch(\"#{agg.name}\", \"#{cmd.name}\"#{args_str})</code></p>"
...
HecksPlayground.capability :client_commands do
  description "Browser-side command dispatch generated from domain IR"
  direction :driving
  on_apply do |runtime|
    HecksPlayground::Capabilities::ClientCommands.apply(runtime)
  end
end
