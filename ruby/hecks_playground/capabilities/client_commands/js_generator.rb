# HecksPlayground::Capabilities::ClientCommands::JsGenerator
#
...
#   gen.generate  # => "// HecksPlayground Client Runtime ..."
#
  ...
  module Capabilities
    module ClientCommands
      ...
      class JsGenerator
        ...
        def header
          <<~JS
            // HecksPlayground Client Runtime — generated from #{@domain.name} Bluebook
        ...
        def footer
          <<~JS
              ...
              window.HecksPlayground = window.HecksPlayground || {};
              window.HecksPlayground.dispatch = dispatch;
              window.HecksPlayground.state = state;
              window.HecksPlayground.handlers = handlers;
              window.HecksPlayground.docs = docs;
            })();
          JS
        end
