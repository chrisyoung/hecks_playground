# HecksPlayground::Capabilities::Crud
#
...
module HecksPlayground
  module Capabilities
    ...
    module Crud
      ...
      #
      # @param runtime [HecksPlayground::Runtime] the runtime
      # @param agg [Structure::Aggregate] the aggregate
      ...
      def self.reserved?(name)
        HecksPlayground::Utils::RESERVED_AGGREGATE_ATTRS.include?(name.to_s)
      end
