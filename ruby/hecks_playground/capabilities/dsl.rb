# HecksPlayground::Capabilities::DSL
#
  ...
  module Capabilities
    ...
    class DSL
      ...
      def register!
        ...
        dir = @direction
        HecksPlayground.describe_capability(name, description: @description, config: schema)
        HecksPlayground.capability_meta[name][:direction] = dir if dir
      end
    end
