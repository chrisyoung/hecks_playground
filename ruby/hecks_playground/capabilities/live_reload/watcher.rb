# HecksPlayground::Capabilities::LiveReload::Watcher
#
...
#
#   watcher = LiveReload::Watcher.new(runtime, watch_dirs: ["hecks_playground"], debounce: 0.5)
  ...
  module Capabilities
    module LiveReload
      ...
      class Watcher
        ...
        def initialize(runtime, watch_dirs: ["hecks_playground"], debounce: 0.5)
          @runtime    = runtime
      ...
      # HecksPlayground::Capabilities::LiveReload::BluebookReloaded
      #
