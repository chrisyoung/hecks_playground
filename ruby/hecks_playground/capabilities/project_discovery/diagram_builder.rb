# HecksPlayground::Capabilities::ProjectDiscovery::DiagramBuilder
#
    ...
    module ProjectDiscovery
      module DiagramBuilder
        def diagram(project_path, domain_name, view = :structure)
          ...
          case view
          when :structure
            HecksPlayground::BluebookVisualizer.new(domain).generate_structure
          when :behavior
            HecksPlayground::BluebookVisualizer.new(domain).generate_behavior
          when :flow
        ...
        def domain_overview
          ...
          HecksPlayground::ContextMapGenerator.new(domain_objects).generate
        end
