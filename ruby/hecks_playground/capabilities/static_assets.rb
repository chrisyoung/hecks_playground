# HecksPlayground::Capabilities::StaticAssets
#
...
module HecksPlayground
  module Capabilities
    ...
    module StaticAssets
      ...
      # @return [HecksPlayground::Capabilities::StaticAssets::Port]
...
HecksPlayground.capability :static_assets do
  ...
  on_apply do |runtime|
    HecksPlayground::Capabilities::StaticAssets.apply(runtime)
  end
end
