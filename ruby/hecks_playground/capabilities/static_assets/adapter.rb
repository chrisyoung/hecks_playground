# HecksPlayground::Capabilities::StaticAssets::Adapter
#
...
#   adapter.mount("/hecks_playground/docs") { |req, res| res.body = "..." }
#   adapter.start
#
require "webrick"
  ...
  module Capabilities
    module StaticAssets
      ...
      class Adapter
        ...
        #
        # @param path [String] URL path (e.g. "/hecks_playground/docs")
