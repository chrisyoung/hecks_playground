# HecksPlayground::Capabilities::UbiquitousLanguage
#
# @domain Layout
#
...
module HecksPlayground
  module Capabilities
    module UbiquitousLanguage
      ...
      # @param runtime [HecksPlayground::Runtime]
      ...
      def self.serve_js(runtime)
        ...
        adapter.mount("/hecks_playground/accessibility.js") do |_req, res|
...
HecksPlayground.capability :ubiquitous_language do
  description "data-domain tags: accessibility, coverage reporting, and UL validation"
  direction :driven
  on_apply do |runtime|
    HecksPlayground::Capabilities::UbiquitousLanguage.apply(runtime)
  end
end
