# HecksPlayground::Capabilities::WebClientState
#
  ...
  module Capabilities
    module WebClientState
      ...
      def self.mount_routes(runtime)
        ...
        adapter.mount("/hecks_playground/state.js") do |_req, res|
...
HecksPlayground.capability :web_client_state do
  description "Optimistic client state with localStorage + correlation dedup"
  direction :driving
  on_apply do |runtime|
    HecksPlayground::Capabilities::WebClientState.apply(runtime)
  end
end
