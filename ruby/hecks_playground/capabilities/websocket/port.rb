# HecksPlayground::Capabilities::Websocket::Port
#
    ...
    module Websocket
      ...
      class Port
        ...
        def handle_message(client, raw)
          ...
          Thread.current[:_hecks_playground_ws_suppress_client] = client if meta[:no_respond]
          ...
          Thread.current[:_hecks_playground_ws_suppress_client] = nil
        end
        ...
        def broadcast_event(event, project: nil)
          ...
          suppress = Thread.current[:_hecks_playground_ws_suppress_client]
