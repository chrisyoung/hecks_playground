# HecksPlayground::Capabilities::Workbench
#
  ...
  module Capabilities
    ...
    module Workbench
      ...
      def self.mount_routes(runtime)
        ...
        adapter.mount("/hecks_playground/workbench.js") do |_req, res|
...
HecksPlayground.capability :workbench do
  description "Interactive domain REPL — attach to commands via hecksagon annotations"
  direction :driving
  on_apply do |runtime|
    HecksPlayground::Capabilities::Workbench.apply(runtime)
  end
end
