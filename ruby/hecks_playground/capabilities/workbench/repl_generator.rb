# HecksPlayground::Capabilities::Workbench::ReplGenerator
#
...
#   gen.generate  # => "// HecksPlayground Workbench ..."
#
  ...
  module Capabilities
    module Workbench
      ...
      class ReplGenerator
        ...
        def header
          <<~JS
            // HecksPlayground Workbench — generated from #{@domain.name} Bluebook
        ...
        def commands_section
          <<~JS
              ...
              function dispatch(out, aggregate, command, args) {
                ...
                } else if (window.HecksPlayground && window.HecksPlayground.dispatch) {
                  var result = window.HecksPlayground.dispatch(aggregate, command, args);
              ...
              function showWelcome(out) {
                appendLine(out, "system", "HecksPlayground Workbench — " + domain.name);
