# HecksPlayground::ChapterLoader
#
# Registry and selective loader for Bluebook chapters. Maps chapter
# names to require paths and setup blocks. Enables composable HecksPlayground
# installations — load only the chapters your project needs.
#
#   HecksPlayground.chapters :bluebook, :runtime           # in code
#   HecksPlayground.chapters :all                          # everything
#
...
module HecksPlayground
  ...
  module ChapterLoader
    ...
    # HecksPlayground::ChapterLoader::FileDSL
    #
