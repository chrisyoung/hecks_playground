# HecksPlayground::Chapters
#
# [antibody-exempt: ruby/hecks_playground/chapters.rb — kernel-floor Ruby chapter
...
#  single hecks_playground/ root into self/ (12 chapters) + bluebook/ (1 chapter,
#  the IR). BLUEBOOK_DIRS searches both new roots and falls back to
#  the legacy hecks_playground/ root for any out-of-tree consumers. No bluebook
...
#  the rest of ruby/hecks_playground/'s kernel-floor markers.]
#
...
#   Chapters.load_aggregates(Targets::Go, base_dir: "go_hecks_playground")
...
module HecksPlayground
  module Chapters
    ...
    def self.load_aggregates(paragraph_module, base_dir:)
      builder = HecksPlayground::DSL::BluebookBuilder.new("tmp")
    ...
    #
    #   Chapters.load_chapter(Bluebook, base_dir: "bluebook/lib")
    #   Chapters.load_chapter(Bluebook, base_dirs: ["lib/hecks_playground/domain", "lib/hecks_playground/dsl"])
    #
    ...
    # Load a chapter definition from a .bluebook file in the hecks_playground/ directory.
    ...
    #                lib/hecks_playground/chapters/<name>.rb. Renamed from self/
    ...
    #                fixed point).
    # The legacy hecks_playground/ root is kept as a final fallback for any
    ...
    BLUEBOOK_DIRS = [
      ...
      File.expand_path("../../../hecks_playground",    __FILE__),  # legacy fallback
    ].freeze
    ...
    def self.definition_from_bluebook(name)
      ...
      # Extract domain name and block body from the HecksPlayground.bluebook header
      ...
      DSL::AggregateBuilder::VoTypeResolution.with_vo_constants do
        ...
        HecksPlayground.last_domain = domain if HecksPlayground.respond_to?(:last_domain=)
        domain
      end
    end
    ...
    # If a top-level HecksPlayground constant shadows a chapter module (e.g.
    # HecksPlayground::Runtime class vs Chapters::Runtime module), install
    ...
    def self.install_chapter_alias(chapter_module = nil)
      return unless defined?(HecksPlayground::ChapterAliases)
      ...
      modules.each do |cm|
        ...
        next unless slug
        next unless HecksPlayground.const_defined?(slug, false)
        target = HecksPlayground.const_get(slug)
  ...
  # Flatten the Chapters namespace: HecksPlayground::Bluebook resolves to
  # HecksPlayground::Bluebook when no direct constant exists.
