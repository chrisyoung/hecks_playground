# HecksPlayground::Chapters::Appeal::AuthoringProjectsParagraph
#
...
#
#   HecksPlayground::Chapters::Appeal::AuthoringProjectsParagraph.define(builder)
#
        ...
        def self.define(b)
          b.aggregate "Project" do
            ...
            command "DiscoverProjects" do
              description "Scan a directory for hecks_playground apps -- looks for hecks_playground/*.bluebook"
