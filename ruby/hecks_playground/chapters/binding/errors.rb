# HecksPlayground::Binding::ErrorsParagraph
#
# Paragraph covering the HecksPlayground error hierarchy. Each error class is
# modeled as an aggregate with a Raise command carrying the parameters
# that the actual constructor accepts.
#
#   HecksPlayground::Binding::ErrorsParagraph.define(builder)
#
module HecksPlayground
  module Chapters
    ...
    # HecksPlayground::Binding::ErrorsParagraph
    #
    # Bluebook sub-chapter modeling the HecksPlayground error hierarchy as aggregates with Raise commands.
    #
    module ErrorsParagraph
      def self.define(b)
        b.aggregate "Error", "Base error class for all HecksPlayground domain errors" do
        ...
        b.aggregate "ConfigurationError", "Raised when HecksPlayground.configure has invalid settings" do
          command("Throw") { attribute :message, String }
        end
