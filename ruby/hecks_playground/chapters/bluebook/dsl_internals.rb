# HecksPlayground::Chapters::Bluebook::DslInternalsParagraph
#
...
#
#   HecksPlayground::Chapters::Bluebook::DslInternalsParagraph.define(builder)
#
    ...
    module Bluebook
      module DslInternalsParagraph
        def self.define(b)
          ...
          b.aggregate "BluebookBuilderMethods", "Top-level HecksPlayground.bluebook method for defining domains" do
