    ...
    module Bluebook
      module ToolingParagraph
        def self.define(b)
          ...
          b.aggregate "ExtensionDocs", "Metadata registry describing all HecksPlayground extensions" do
