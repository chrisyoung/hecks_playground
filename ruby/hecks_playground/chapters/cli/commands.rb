# = HecksPlayground::Chapters::Cli::CliCommands
#
# Self-describing sub-chapter for individual CLI commands. Each command
# is a Thor subcommand under `hecks_playground <command>`.
#
#   HecksPlayground::Chapters::Cli::CliCommands.define(builder)
#
module HecksPlayground
  module Chapters
    module Cli
      ...
      module CliCommands
        def self.define(b)
          b.aggregate "InitCommand", "Scaffolds a new HecksPlayground domain project" do
          ...
          b.aggregate "CompileCommand", "Compiles HecksPlayground into a self-contained binary" do
          ...
          b.aggregate "NewProjectCommand", "Scaffolds a new HecksPlayground domain project" do
