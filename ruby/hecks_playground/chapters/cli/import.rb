# = HecksPlayground::Chapters::Cli::CliImport
#
# Self-describing sub-chapter for the Rails-to-HecksPlayground import pipeline.
# Covers schema parsing, model parsing, domain assembly, and AST helpers.
#
#   HecksPlayground::Chapters::Cli::CliImport.define(builder)
#
module HecksPlayground
  module Chapters
    module Cli
      # HecksPlayground::Chapters::Cli::CliImport
      #
      # Bluebook sub-chapter for the Rails-to-HecksPlayground import pipeline aggregates.
      #
      module CliImport
        def self.define(b)
          b.aggregate "DomainAssembler", "Combines schema and model data into HecksPlayground DSL source" do
          ...
          b.aggregate "ModelOnlyAssembler", "Builds HecksPlayground DSL from model files without schema.rb" do
