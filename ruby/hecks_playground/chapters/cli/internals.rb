# = HecksPlayground::Chapters::Cli::CliInternals
#
...
#
#   HecksPlayground::Chapters::Cli::CliInternals.define(builder)
#
    ...
    module Cli
      ...
      module CliInternals
        def self.define(b)
          ...
          b.aggregate "Import", "Reverse-engineers Rails apps into HecksPlayground domain definitions" do
