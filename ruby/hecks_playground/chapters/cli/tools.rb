    ...
    module Cli
      ...
      module CliTools
        def self.define(b)
          ...
          b.aggregate "GemBuilder", "Builds and installs HecksPlayground component gems" do
