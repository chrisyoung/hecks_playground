      ...
      module SqlParagraph
        def self.define(b)
          b.aggregate "SqlAdapterGenerator" do
            ...
            namespace "HecksPlayground::Generators::SQL"
          ...
          b.aggregate "SqlStrategy" do
            ...
            namespace "HecksPlayground::Migrations::Strategies"
            includes "SqlHelpers"
          ...
          b.aggregate "SqlSetup" do
            description "Generates and evals SQL adapter classes at boot time for HecksPlayground.configure"
            namespace "HecksPlayground::Configuration"
            command "Setup"
          end
