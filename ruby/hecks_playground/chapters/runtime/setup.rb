# = HecksPlayground::Chapters::Runtime::Setup
#
...
#
#   HecksPlayground::Chapters::Runtime::Setup.define(builder)
#
    ...
    module Runtime
      ...
      module Setup
        def self.define(b)
          ...
          b.aggregate "ConfigurationDSL", "DSL methods for HecksPlayground.configure block" do
