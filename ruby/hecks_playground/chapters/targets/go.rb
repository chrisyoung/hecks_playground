# HecksPlayground::Chapters::Targets::Go
#
...
#
#   HecksPlayground::Chapters::Targets::Go.define(builder)
#
module HecksPlayground
  module Chapters
    module Targets
      module Go
        def self.summary = "Go domain generator for HecksPlayground"
        ...
        def self.define(b)
          ...
          b.aggregate "GoErrorsGenerator", "Generates Go error types matching the hecks_playground error hierarchy" do
