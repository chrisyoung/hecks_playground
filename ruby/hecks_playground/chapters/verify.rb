# HecksPlayground::Chapters.verify
#
...
#
#   HecksPlayground::Chapters.verify                        # => dots (progress)
#   HecksPlayground::Chapters.verify(format: :documentation) # => verbose tree
#
# Run from CLI:
...
module HecksPlayground
  module Chapters
    ...
    def self.verify(format: :progress, verbose: false)
      ...
      require "hecks_playground/chapters/verify_contracts"
      ...
      puts "" if format == :progress
      require "hecks_playground/chapters/verify_runtime"
      ...
      puts "" if format == :progress
      require "hecks_playground/chapters/verify_generators"
      ...
      warnings = []
      puts "" if format == :progress
      require "hecks_playground/chapters/verify_coverage"
      ...
      puts "" if format == :progress
      require "hecks_playground/chapters/verify_parity"
