# HecksPlayground::Chapters::CoverageVerifier
#
...
# proving the Bluebook is a complete specification of HecksPlayground.
#
#   result = HecksPlayground::Chapters::CoverageVerifier.run(format: :progress)
...
module HecksPlayground
  module Chapters
    class CoverageVerifier
      ...
      LIB_DIRS = %w[
        bluebook/lib hecksties/lib hecksagon/lib hecks_playground_workshop/lib
        hecks_playground_ai/lib hecks_playground_on_rails/lib
        hecks_playground_targets/ruby/lib hecks_playground_targets/go/lib hecks_playground_targets/node/lib
      ...
      SKIP_PATTERNS = %w[
        ...
        bluebook.rb hecksagon.rb hecks_playground_workshop.rb hecks_playground_ai.rb
        hecks_playground_on_rails.rb hecks_playground_serve.rb
        hecks_playground_targets.rb hecks_playground_multidomain.rb
        self_compile.rb
      ].freeze
