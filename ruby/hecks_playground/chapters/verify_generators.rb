# HecksPlayground::Chapters::GeneratorVerifier
#
...
#
#   HecksPlayground::Chapters::GeneratorVerifier.run
#   HecksPlayground::Chapters::GeneratorVerifier.run(format: :documentation)
#
  ...
  module Chapters
    module GeneratorVerifier
      ...
      def self.run(format: :progress)
        ...
        load_generators
        app = HecksPlayground.boot(File.join(Dir.pwd, "examples/pizzas"))
        domain = app.domain
