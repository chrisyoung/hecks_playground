# HecksPlayground::Chapters::ParityVerifier
#
...
#
#   HecksPlayground::Chapters::ParityVerifier.run
#   HecksPlayground::Chapters::ParityVerifier.run(format: :documentation)
#
  ...
  module Chapters
    module ParityVerifier
      ...
      def self.run(format: :progress)
        ...
        chapters = HecksPlayground::Chapters.constants
          .map { |c| HecksPlayground::Chapters.const_get(c) }
