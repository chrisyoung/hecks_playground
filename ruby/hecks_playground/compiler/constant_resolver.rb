# HecksPlayground::Compiler::ConstantResolver
#
...
#   resolver.resolve("HecksPlayground::DSL::BluebookBuilder")
#     # => "/path/to/lib/hecks_playground/dsl/bluebook_builder.rb"
#
module HecksPlayground
  module Compiler
    class ConstantResolver
      ...
      #
      # @param ref [String] constant path (e.g. "HecksPlayground::DSL::BluebookBuilder")
      ...
      # E.g., "BluebookVisualizer" matches "HecksPlayground::BluebookVisualizer".
