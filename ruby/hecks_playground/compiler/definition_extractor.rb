# HecksPlayground::Compiler::DefinitionExtractor
#
# Prism AST visitor that extracts class and module definitions from
# a Ruby source file. Tracks the full constant path (e.g. HecksPlayground::Compiler)
# and distinguishes namespace-only modules from real definitions.
#
#   result = DefinitionExtractor.extract(source)
#   result.definitions  # => ["HecksPlayground::Compiler::SourceAnalyzer"]
#   result.namespaces   # => ["HecksPlayground", "HecksPlayground::Compiler"]
#
require "prism"
