# HecksPlayground::Compiler::ForwardDeclarations
#
# Generates forward declarations and early extensions needed in the
# bundled binary. In the interpreted runtime, hecks_playground.rb orchestrates
...
module HecksPlayground
  module Compiler
    module ForwardDeclarations
      ...
      # Writes the registry extend calls that normally live in hecks_playground.rb.
      ...
      REGISTRY_EXTENDS = <<~'RUBY'
        # Early registry extension (from hecks_playground.rb)
        module HecksPlayground
