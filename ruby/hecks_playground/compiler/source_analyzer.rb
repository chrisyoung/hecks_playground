# HecksPlayground::Compiler::SourceAnalyzer
#
# Orchestrates static analysis of HecksPlayground Ruby source files using
  ...
  module Compiler
    module SourceAnalyzer
      ...
      PRIORITY_PATTERNS = %w[
        ...
        /registries/
        /naming_helpers.rb
        hecks_playground/generator.rb
        hecks_playground/dry_run_result.rb
      ].freeze
      ...
      EXCLUDED_DIRS = %w[
        ...
        /hecks_playground_cli/ /hecks_playground_serve/ /hecks_playground_mongodb/
        /hecks_playground_ai/
      ].freeze
      ...
      # Maps HecksPlayground.method_name calls to the registry files that define them.
      ...
      # Registry files define methods that get extended onto HecksPlayground.
      #
