# = HecksPlayground::Conventions::CsrfContract
#
...
#   HecksPlayground::Conventions::CsrfContract::COOKIE_NAME  # => "_csrf_token"
#   HecksPlayground::Conventions::CsrfContract::HEADER_NAME  # => "X-CSRF-Token"
#
