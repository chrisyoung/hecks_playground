# = HecksPlayground::Conventions::EventContract
#
...
# for source tagging.
#
#   HecksPlayground::Conventions::EventContract::SOURCE_ATTR       # => :@_source_domain
#   HecksPlayground::Conventions::EventContract.validate(event_ir, [:name, :description])
