# = HecksPlayground::Conventions::EventLogContract
#
...
#
#   HecksPlayground::Conventions::EventLogContract::FIELDS      # => [:name, :occurred_at]
#   HecksPlayground::Conventions::EventLogContract.go_struct    # => Go struct definition
#   HecksPlayground::Conventions::EventLogContract.ruby_mapper  # => Ruby event-to-hash code
#
