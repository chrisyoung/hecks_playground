# = HecksPlayground::Conventions::FormParsingContract
#
...
#
#   HecksPlayground::Conventions::FormParsingContract.input_type("int64")    # => "number"
#   HecksPlayground::Conventions::FormParsingContract.parse_format("int64")  # => "%d"
#   HecksPlayground::Conventions::FormParsingContract.spec("time.Time")      # => { input: "date", ... }
#
