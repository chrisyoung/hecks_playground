# = HecksPlayground::Conventions::TypeContract
#
...
#
#   HecksPlayground::Conventions::TypeContract.for(:go, "Integer")  # => "int64"
#   HecksPlayground::Conventions::TypeContract.for(:sql, "Integer") # => "INTEGER"
#
#   # New targets register themselves:
#   HecksPlayground::Conventions::TypeContract.register_target(:java, {
