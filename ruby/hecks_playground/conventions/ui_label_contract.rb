# = HecksPlayground::Conventions::UILabelContract
#
...
#
#   HecksPlayground::Conventions::UILabelContract.label(:effective_date)    # => "Effective Date"
#   HecksPlayground::Conventions::UILabelContract.label(:pizza_id)          # => "Pizza"
#   HecksPlayground::Conventions::UILabelContract.label("ReportIncident")   # => "Report Incident"
#   HecksPlayground::Conventions::UILabelContract.plural_label("GovernancePolicy")  # => "Governance Policies"
#
