# = HecksPlayground::Conventions::ViewContract
#
...
#
#   contract = HecksPlayground::Conventions::ViewContract::INDEX
#   contract[:fields]  # => [{name: :aggregate_name, type: :string}, ...]
#   HecksPlayground::Conventions::ViewContract.go_name(:short_id)  # => "ShortId"
#
module HecksPlayground::Conventions
  ...
  module ViewContract
    ...
    def self.go_name(field)
      HecksPlayground::Utils.sanitize_constant(field)
    end
