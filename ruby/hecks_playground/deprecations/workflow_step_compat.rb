...
# CommandStep
HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::CommandStep, :[]) do |key|
...
HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::CommandStep, :to_h) do
  HecksDeprecations.warn_deprecated(self.class, "to_h")
  { command: command, mapping: mapping }
end

# BranchStep
HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::BranchStep, :[]) do |key|
  HecksDeprecations.warn_deprecated(self.class, "[]")
  case key
...
HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::BranchStep, :to_h) do
  HecksDeprecations.warn_deprecated(self.class, "to_h")
  { branch: { spec: spec, if_steps: if_steps, else_steps: else_steps } }
end

# ScheduledStep
HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::ScheduledStep, :[]) do |key|
  HecksDeprecations.warn_deprecated(self.class, "[]")
  send(key) if respond_to?(key)
end

HecksDeprecations.register(HecksPlayground::BluebookModel::Behavior::ScheduledStep, :to_h) do
  HecksDeprecations.warn_deprecated(self.class, "to_h")
