# HecksPlayground::DomainPresentation
#
# Compiled from nursery/hecks_playground/domain_presentation.bluebook.
# Each domain concept knows how to express itself as a panel.
# The UI reads render_mode, color, icon — never hardcodes them.
#
#   HecksPlayground::DomainPresentation.for(:command)
#   # => { render_mode: "form", color: "#58a6ff", icon: "C", content_shape: "list" }
#
#   HecksPlayground::DomainPresentation.express(aggregate)
