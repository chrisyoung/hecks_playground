# HecksPlayground::DomainVersioning::BreakingBumper
#
...
module HecksPlayground
  module DomainVersioning
    ...
    module BreakingBumper
      ...
      #
      # @param old_domain [HecksPlayground::BluebookModel::Domain, nil] previous snapshot (nil = first build)
      # @param new_domain [HecksPlayground::BluebookModel::Domain] current domain
      # @param versioner [HecksPlayground::Versioner] CalVer versioner instance
