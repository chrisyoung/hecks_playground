# [antibody-exempt: ruby/hecks_playground/dsl/aggregate_builder.rb — kernel-surface
...
#  Same i147 long-arc retirement contract as the rest of ruby/hecks_playground/dsl/ :
#  retires when the Ruby parser is fully described by
#  hecks_playground_conception/aggregates/language/grammar/*.bluebook plus a generated
#  artifact.]
#
...
require "hecks_playground/dsl/projection_builder"
require "hecks_playground/dsl/aggregate_builder/behavior_methods"
require "hecks_playground/dsl/aggregate_builder/constraint_methods"
require "hecks_playground/dsl/aggregate_builder/query_methods"
require "hecks_playground/dsl/aggregate_builder/vo_type_resolution"

module HecksPlayground
  module DSL

    # HecksPlayground::DSL::AggregateBuilder
    #
    ...
    class AggregateBuilder
      ...
      #
      #   HecksPlayground::DSL::AggregateBuilder.register_facet(:sagas) do |builder|
      ...
      def generate_crud_commands
        ...
        reserved = HecksPlayground::Utils.respond_to?(:RESERVED_AGGREGATE_ATTRS) ? HecksPlayground::Utils::RESERVED_AGGREGATE_ATTRS : %w[id created_at updated_at]
