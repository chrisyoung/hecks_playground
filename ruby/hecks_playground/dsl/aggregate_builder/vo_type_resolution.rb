# HecksPlayground::DSL::AggregateBuilder::VoTypeResolution
#
# @domain Layout
#
      ...
      module VoTypeResolution
        def self.with_vo_constants
          ...
          Object.define_singleton_method(:const_missing) do |name|
            if Thread.current[:_hecks_playground_vo_eval]
              qualified = name.to_s
              mod = Module.new
          ...
          Thread.current[:_hecks_playground_vo_eval] = true
          yield
        ensure
          Thread.current[:_hecks_playground_vo_eval] = false
          if saved
