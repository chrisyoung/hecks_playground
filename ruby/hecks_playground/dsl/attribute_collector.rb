# [antibody-exempt: ruby/hecks_playground/dsl/attribute_collector.rb — kernel-surface
...
module HecksPlayground
  module DSL
    ...
    # HecksPlayground::DSL::AttributeCollector
    #
    ...
    module AttributeCollector
      ...
      def attribute(name = nil, type = nil, **options, &block)
        ...
        if type.class == String && HecksPlayground::DSL::TypeName.match?(type)
      ...
      #   attribute :toppings, list_of("Topping")
      def list_of(type)
        raise ArgumentError, "Use bare constant #{type} instead of string \"#{type}\" in list_of" if type.class == String && HecksPlayground::DSL::TypeName.match?(type)
        { list: type }
      end
      ...
      def type_is_vo?(type)
        ...
        HecksPlayground::DSL::TypeName.match?(type.to_s)
      end
    end
  end
end
