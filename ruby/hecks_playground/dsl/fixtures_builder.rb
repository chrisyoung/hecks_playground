# HecksPlayground::DSL::FixturesBuilder
#
# DSL entry point for `HecksPlayground.fixtures "Pizzas" do ... end` — the
...
# Surface (kept small):
#
#   HecksPlayground.fixtures "Pizzas" do
#     aggregate "Pizza" do
...
# changed.
require "hecks_playground/bluebook_model/structure/fixture"
...
module HecksPlayground
  module DSL
    class FixturesBuilder
      ...
      # Top-level narrative inside a `HecksPlayground.fixtures` block — documentation
