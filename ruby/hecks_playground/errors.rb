# = HecksPlayground::Errors
#
# Custom error hierarchy for the HecksPlayground framework. All HecksPlayground exceptions
# inherit from {HecksPlayground::Error}, which itself inherits from +StandardError+.
#
...
# == Usage
#
#   raise HecksPlayground::GuardRejected, "Must be admin"
#   raise HecksPlayground::MigrationError, "Column already exists"
#   raise HecksPlayground::ValidationError, "Name cannot be blank"
#
#   begin
#     app["Pizza"].create(name: "")
#   rescue HecksPlayground::ValidationError => e
#     puts e.message
#   end
#
module HecksPlayground
  # Base error class for all HecksPlayground framework exceptions. Rescue this to
  # catch any HecksPlayground-specific error. Provides +as_json+ and +to_json+ for
  ...
  class Error < StandardError
    ...
    def as_json
      { error: HecksPlayground::Utils.const_short_name(self), message: message }
    end
  ...
  #
  #   raise HecksPlayground::ValidationError.new("Name cannot be blank", field: :name, rule: :presence)
  class ValidationError < Error
    ...
    #
    #   HecksPlayground::ValidationError.for_domain(["No fields", "Missing event"])
  ...
  #
  #   raise HecksPlayground::GuardRejected.new("Insufficient funds",
  ...
  #
  #   raise HecksPlayground::PreconditionError.new("Precondition failed: balance >= 0",
  #     invariant: "balance >= 0")
  ...
  # Raised when a +version:+ kwarg passed to +HecksPlayground.bluebook+ does not conform
  # to semver (+x.y.z+) or CalVer (+YYYY.MM.DD.N+).
  #
  #   HecksPlayground.bluebook "Banking", version: "bad"  # => InvalidBluebookVersion
  ...
  # (i.e., +HecksPlayground.actor+ is nil).
  ...
  #
  #   raise HecksPlayground::PathTraversalDetected.new(
  #     attempted_path: "../etc/passwd",
  #     output_dir: "/tmp/my_domain"
  #   )
  class PathTraversalDetected < HecksPlayground::Error
  ...
  #
  #   raise HecksPlayground::ReferenceNotFound.new(
  ...
  #
  #   raise HecksPlayground::ReferenceAccessDenied.new(
