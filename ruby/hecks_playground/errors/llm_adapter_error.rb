# HecksPlayground::LlmAdapterError / LlmInvocationSkipped / LlmInvocationFailed
#
# Errors raised (or returned) by HecksPlayground::Runtime::LlmDispatcher when an
# LLM adapter invocation cannot proceed or fails. Mirrors the layout
# of HecksPlayground::ShellAdapterError but distinguishes two non-success modes:
#
...
#
#   raise HecksPlayground::LlmAdapterError.new(
#     "claude transport: connection refused",
#     adapter: :speech, provider: :claude
#   )
#
#   skipped = HecksPlayground::LlmInvocationSkipped.new(
