# HecksPlayground::EventSourcing::EventStore
#
...
#
class HecksPlayground::EventSourcing::EventStore
  # HecksPlayground::EventSourcing::EventStore::Entry
  #
  ...
  # @raise [HecksPlayground::ConcurrencyError] if expected_version mismatches
  def append(stream_id, event_type:, data:, schema_version: 1,
    ...
    @mutex.synchronize do
      ...
      if expected_version && expected_version != current
        raise HecksPlayground::ConcurrencyError,
