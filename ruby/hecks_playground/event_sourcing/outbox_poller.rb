# HecksPlayground::EventSourcing::OutboxPoller
#
...
#   poller.stop
#
class HecksPlayground::EventSourcing::OutboxPoller
  # @param outbox [HecksPlayground::EventSourcing::Outbox] the outbox to poll
  # @param event_bus [HecksPlayground::EventBus] the bus to publish events on
