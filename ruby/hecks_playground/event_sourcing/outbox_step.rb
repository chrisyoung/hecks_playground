# HecksPlayground::EventSourcing::OutboxStep
#
...
#
class HecksPlayground::EventSourcing::OutboxStep
  # @param outbox [HecksPlayground::EventSourcing::Outbox] the outbox to write to
