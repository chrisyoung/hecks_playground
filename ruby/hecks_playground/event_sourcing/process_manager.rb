# HecksPlayground::EventSourcing::ProcessManager
#
...
#
class HecksPlayground::EventSourcing::ProcessManager
  # HecksPlayground::EventSourcing::ProcessManager::Handler
  #
  ...
  # @return [HecksPlayground::SagaStore] the backing store for process instances
  attr_reader :store

  # @param name [String] the process manager name
  # @param store [HecksPlayground::SagaStore] the store for process instances
  ...
  def handle(event)
    event_type = HecksPlayground::Utils.const_short_name(event)
  ...
  #
  # @param event_bus [HecksPlayground::EventBus] the bus to listen on
  # @return [void]
