# HecksPlayground::EventSourcing::ProjectionRebuilder
#
...
#
class HecksPlayground::EventSourcing::ProjectionRebuilder
  # @param event_store [HecksPlayground::EventSourcing::EventStore] the source of events
  # @param upcaster_engine [HecksPlayground::EventSourcing::UpcasterEngine, nil] optional upcaster
