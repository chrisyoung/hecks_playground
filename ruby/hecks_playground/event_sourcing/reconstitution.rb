# HecksPlayground::EventSourcing::Reconstitution
#
...
#   # => { name: "Margherita" }
#
class HecksPlayground::EventSourcing::Reconstitution
  # @param event_store [HecksPlayground::EventSourcing::EventStore]
  # @param snapshot_store [HecksPlayground::EventSourcing::SnapshotStore, nil]
