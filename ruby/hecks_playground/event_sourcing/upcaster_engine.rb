# HecksPlayground::EventSourcing::UpcasterEngine
#
...
#
class HecksPlayground::EventSourcing::UpcasterEngine
  # @param registry [HecksPlayground::EventSourcing::UpcasterRegistry]
