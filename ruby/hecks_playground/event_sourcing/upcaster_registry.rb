# HecksPlayground::EventSourcing::UpcasterRegistry
#
...
#
class HecksPlayground::EventSourcing::UpcasterRegistry
  # HecksPlayground::EventSourcing::UpcasterRegistry::Upcaster
  #
