module HecksPlayground
  module EventStorm
    # HecksPlayground::EventStorm::DslGenerator
    #
    # Generates a HecksPlayground Ruby DSL file from a Parser::ParseResult. Produces
    # editable source code with TODO placeholders for attributes that need
    # to be filled in after the event storm.
    #
    # Part of the EventStorm module. Used by HecksPlayground.from_event_storm to produce
    ...
    #   puts dsl  # => "HecksPlayground.bluebook \"Ordering\" do ..."
    #
    class DslGenerator
      ...
      # Generates the HecksPlayground DSL source code string.
      #
      # Produces a complete HecksPlayground.bluebook block with aggregate, command, and
      ...
      def generate
        ...
        lines << "HecksPlayground.bluebook \"#{@name}\" do"
