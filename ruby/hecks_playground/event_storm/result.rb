module HecksPlayground
  module EventStorm
    # HecksPlayground::EventStorm::Result
    #
    # Return value from HecksPlayground.from_event_storm. Contains the built Domain object,
    # the generated DSL string, and any warnings produced during parsing.
    #
    #   result = HecksPlayground.from_event_storm("storm.md")
    #   result.domain    # => BluebookModel::Structure::Domain
    #   result.dsl       # => "HecksPlayground.bluebook \"Ordering\" do ..."
    ...
    class Result
      ...
      # @return [String] the generated HecksPlayground DSL source code
      attr_reader :dsl
      ...
      # @param dsl [String] the generated HecksPlayground DSL source code
