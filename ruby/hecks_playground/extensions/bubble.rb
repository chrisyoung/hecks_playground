# HecksBubble
#
# Anti-Corruption Layer (ACL) extension for HecksPlayground domains. Defines
...
#
# Usage:
#   require "hecks_playground/extensions/bubble"
#
...
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Extensions::BubbleChapter,
  base_dir: File.expand_path("bubble", __dir__)
)

HecksPlayground.describe_extension(:bubble,
  description: "Anti-corruption layer for legacy data translation",
  adapter_type: :driven,
  config: {},
  wires_to: :commands)

HecksPlayground.register_extension(:bubble) do |domain_mod, _domain, _runtime|
