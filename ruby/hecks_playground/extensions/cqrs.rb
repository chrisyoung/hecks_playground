...
# HecksCqrs
#
# CQRS (Command Query Responsibility Segregation) support for HecksPlayground domains.
...
# Registers with the HecksPlayground connection registry so domains can declare
...
# Register with HecksPlayground connection registry if available
if defined?(HecksPlayground) && HecksPlayground.respond_to?(:extension_registry)
  HecksPlayground.extension_registry[:cqrs] = HecksCqrs
end
