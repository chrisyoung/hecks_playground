...
#
HecksPlayground.describe_extension(:information,
...
HecksPlayground.register_extension(:information) do |domain_mod, domain, runtime|
  require "zlib"
  require "fileutils"
  ...
  domain.aggregates.each do |agg|
    repo = HecksPlayground::InformationRepository.new(
      agg.name,
...
module HecksPlayground
  # HecksPlayground::InformationRepository
  #
  ...
  class InformationRepository
    ...
    def serialize_value(val)
      ...
      when HecksPlayground::Persistence::CollectionProxy then val.map { |item| serialize_value(item) }
      when HecksPlayground::Persistence::CollectionItem then serialize_value(val.__raw__)
      when ->(v) { v.class.respond_to?(:hecks_playground_attributes) }
        result = {}
