# HecksPlayground::Queue
#
# Message queue extension for HecksPlayground. Subscribes to the domain event bus
...
# external systems.
#
# Future gem: hecks_playground_queue
#
# Usage:
#   app = HecksPlayground.boot(__dir__) do
...
HecksPlayground.describe_extension(:queue,
...
HecksPlayground.register_extension(:queue) do |domain_mod, domain, runtime|
  ...
  queue_adapter = HecksPlayground::Queue.resolve_adapter(adapter, domain)
...
# HecksPlayground
#
# Top-level HecksPlayground module — reopened here to establish namespace before HecksPlayground::Queue definition.
#
...
module HecksPlayground::Queue
  ...
  # @param domain [HecksPlayground::Domain] the domain definition
