module HecksPlayground
  module HTTP
    # HecksPlayground::HTTP::CommandBusPort
    #
    ...
    #
    # Usage:
    #   port = HecksPlayground::HTTP::CommandBusPort.new(command_bus: bus)
    ...
    class CommandBusPort
      ...
      # @param command_bus [HecksPlayground::Commands::CommandBus] the bus for mutation dispatch
