module HecksPlayground
  module Connections
    # HecksPlayground::Connections::HttpConnection
    #
    # Connection wrapper that packages the HTTP REST server as a +listens_to+
    # connection for declarative boot blocks. Wraps a {HecksPlayground::HTTP::DomainServer}
    ...
    class HttpConnection
      ...
      #
      # Instantiates a {HecksPlayground::HTTP::DomainServer} configured with the given
      ...
      # @param runtime [HecksPlayground::Runtime] the runtime instance (passed through
