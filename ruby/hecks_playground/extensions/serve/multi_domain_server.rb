...
require "hecks_playground/extensions/web_explorer/renderer"
require "hecks_playground/extensions/web_explorer/ir_introspector"
require "hecks_playground/extensions/web_explorer/runtime_bridge"
require "hecks_playground/extensions/web_explorer/event_introspector"

module HecksPlayground
  module HTTP
    # HecksPlayground::HTTP::MultiDomainServer
    #
    # WEBrick server that serves multiple HecksPlayground domains in one process.
    ...
    class MultiDomainServer
      ...
      def run
        puts "HecksPlayground serving #{@domains.size} domains on http://localhost:#{@port}"
      ...
      def setup_domains
        ...
        @renderer = HecksPlayground::WebExplorer::Renderer.new(views_dir)
        @nav = build_nav
