...
module HecksPlayground
  module HTTP
    # HecksPlayground::HTTP::RouteBuilder
    #
    ...
    #
    # Used by {HecksPlayground::HTTP::DomainServer} to build its routing table. The
    ...
    class RouteBuilder
      ...
      #
      # @param domain [HecksPlayground::Domain] the parsed domain definition containing
      ...
      def crud_routes(agg, klass, slug)
        ...
        if create_cmd
          ...
          HecksPlayground::Conventions::DispatchContract.validate!(@whitelist, agg.name, create_method)
      ...
      #
      # Uses {HecksPlayground::Utils.object_attr_names} to discover attribute names,
      ...
      def serialize(obj)
        HecksPlayground::Utils.object_attr_names(obj).each_with_object({}) do |name, h|
