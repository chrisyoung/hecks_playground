...
module HecksPlayground
  module HTTP
    class MultiDomainServer
      module UIRoutes
        # HecksPlayground::HTTP::MultiDomainServer::UIRoutes::RouteDispatcher
        #
        ...
        module RouteDispatcher
          ...
          def valid_csrf?(req)
            ...
            form_val = req.query[HecksPlayground::Conventions::CsrfContract::FIELD_NAME]
            HecksPlayground::Conventions::CsrfContract.valid?(cookie_val, form_val)
          end
        end
      end
    end
