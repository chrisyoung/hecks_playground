...
module HecksPlayground
  module HTTP
    class MultiDomainServer
      module UIRoutes
        # HecksPlayground::HTTP::MultiDomainServer::UIRoutes::ShowRoute
        #
        ...
        module ShowRoute
          ...
          def build_show_fields(ir, bridge, obj, agg)
            ...
            ir.computed_attributes(agg).each do |ca|
              fields << {
                label: "#{HecksPlayground::Utils.humanize(HecksPlayground::Utils.sanitize_constant(ca.name))} (computed)",
