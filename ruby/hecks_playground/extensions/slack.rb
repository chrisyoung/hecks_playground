# HecksSlack
#
# Slack webhook extension for HecksPlayground. Subscribes to the domain event bus
# and POSTs a summary of every event to a Slack incoming webhook URL.
#
# Future gem: hecks_playground_slack
#
# Usage:
...
HecksPlayground.describe_extension(:slack,
...
HecksPlayground.register_extension(:slack) do |domain_mod, domain, runtime|
  ...
  runtime.event_bus.on_any do |event|
    ...
    Thread.new do
      ...
      warn "[hecks_playground:slack] Failed to post: #{e.message}"
    end
  end
end
