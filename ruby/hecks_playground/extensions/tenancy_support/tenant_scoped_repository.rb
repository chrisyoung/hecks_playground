  ...
  # and maintains separate instances keyed by tenant ID (from +HecksPlayground.tenant+).
  ...
  #
  # When +HecksPlayground.tenant+ is nil, operations fall back to a "__default__" tenant.
...
module HecksTenancy
  ...
  class TenantScopedRepository
    ...
    #
    # Reads +HecksPlayground.tenant+ to determine the current tenant ID. Falls back
    ...
    def for_tenant
      tenant = HecksPlayground.tenant || "__default__"
