...
#
# Future gem: hecks_playground_transactions
#
#   require "hecks_playground_transactions"
...
HecksPlayground.describe_extension(:transactions,
  description: "Transactional command execution with rollback",
  adapter_type: :driven,
  config: {},
  wires_to: :command_bus)

HecksPlayground.register_extension(:transactions) do |domain_mod, domain, runtime|
