# HecksPlayground::WebExplorer::IRIntrospector
#
...
module HecksPlayground
  module WebExplorer
    ...
    class IRIntrospector
      ...
      def diagram_data
        viz = HecksPlayground::DomainVisualizer.new(@domain)
        flow = HecksPlayground::FlowGenerator.new(@domain)
        {
      ...
      def humanize(name)
        HecksPlayground::Utils.humanize(HecksPlayground::Utils.sanitize_constant(name))
      end
    end
  end
end
