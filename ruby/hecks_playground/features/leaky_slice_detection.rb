  # HecksPlayground::Features::LeakySliceDetection
  #
  ...
  #
module HecksPlayground::Features

  class LeakySliceDetection < HecksPlayground::ValidationRules::BaseRule
    def errors
      []
    end
  ...
  HecksPlayground.register_validation_rule(LeakySliceDetection)
end
