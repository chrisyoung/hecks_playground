# HecksPlayground::Generators::ExampleBluebookWriter
#
...
#   writer.generate_bluebook   # => "HecksPlayground.bluebook \"Spec\" do ..."
#   writer.generate_hecksagon  # => "HecksPlayground.hecksagon \"Spec\" do ..."
#
  ...
  module Generators
    class ExampleBluebookWriter
      ...
      def generate_bluebook
        lines = []
        lines << "HecksPlayground.bluebook #{@name.inspect} do"
      ...
      def generate_hecksagon
        ...
        lines << "#"
        lines << "HecksPlayground.hecksagon #{@name.inspect} do"
