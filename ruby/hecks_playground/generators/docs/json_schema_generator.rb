module HecksPlayground
  module HTTP
    # HecksPlayground::HTTP::JsonSchemaGenerator
    #
    ...
    #
    #   HecksPlayground::HTTP::JsonSchemaGenerator.new(domain).generate
    #
    class JsonSchemaGenerator < HecksPlayground::Generator
      ...
      def generate
        {
          ...
          description: "Generated by HecksPlayground",
      ...
      # required +id+ field.
      #
      # @param ent [HecksPlayground::BluebookModel::Structure::Entity] the entity
      ...
      #
      # @param evt [HecksPlayground::BluebookModel::Behavior::Event] the event
      # @return [Hash] JSON Schema object definition
      def event_def(evt)
      ...
      #
      # @param agg [HecksPlayground::BluebookModel::Structure::Aggregate] the owning aggregate
      # @param query [HecksPlayground::BluebookModel::Behavior::Query] the query
