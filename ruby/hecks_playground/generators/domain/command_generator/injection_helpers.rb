  ...
  module Generators
    module Domain
      ...
      class CommandGenerator < HecksPlayground::Generator
        # HecksPlayground::Generators::Domain::CommandGenerator::InjectionHelpers
        #
        ...
        module InjectionHelpers
          ...
          # generates an +unless+ check that raises +HecksPlayground::Error+ if the current state
          ...
          #
          # @param agg_attr [HecksPlayground::BluebookModel::Structure::Attribute] an aggregate attribute to check
          # @return [HecksPlayground::BluebookModel::Structure::Attribute, nil] the matching singular command
          ...
          #
          # @param agg_attr [HecksPlayground::BluebookModel::Structure::Attribute] a list_of aggregate attribute
          ...
          def agg_attrs
            ...
            @aggregate.attributes.reject { |attr| HecksPlayground::Utils::RESERVED_AGGREGATE_ATTRS.include?(attr.name.to_s) }
          end
