module HecksPlayground
  module Generators
    module Domain
    # HecksPlayground::Generators::Domain::EntityGenerator
    #
    # Generates mutable sub-entity classes that include HecksPlayground::Model. Entities
    ...
    class EntityGenerator
      ...
      #
      # Produces a class nested under the aggregate that includes HecksPlayground::Model,
      ...
      def generate
        ...
        lines << "      include HecksPlayground::Model"
        lines << ""
      ...
      def source_from_block(block)
        "proc { #{HecksPlayground::Utils.block_source(block)} }"
      end
    end
    end
  end
