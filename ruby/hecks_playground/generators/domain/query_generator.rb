module HecksPlayground
  module Generators
    module Domain
    # HecksPlayground::Generators::Domain::QueryGenerator
    #
    ...
    # HecksPlayground::Query mixin is injected at load time by InMemoryLoader or by
    ...
    class QueryGenerator
      ...
      def initialize(query, domain_module:, aggregate_name:, mixin_prefix: "HecksPlayground")
        @query = query
      ...
      def generate
        ...
        lines << "      class #{HecksPlayground::Utils.sanitize_constant(@query.name.to_s)}"
      ...
      def call_body
        HecksPlayground::Utils.block_source(@query.block)
      end
    end
    end
  end
