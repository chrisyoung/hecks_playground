module HecksPlayground
  module Generators
    module Domain
    # HecksPlayground::Generators::Domain::QueryObjectGenerator
    #
    ...
    #
    class QueryObjectGenerator < HecksPlayground::Generator

      # Initializes the query object generator.
      #
      # @param aggregate [HecksPlayground::BluebookModel::Structure::Aggregate] the aggregate whose
      ...
      #
      # @return [Array<HecksPlayground::BluebookModel::Structure::Attribute>] scalar, non-reference attributes
