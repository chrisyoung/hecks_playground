module HecksPlayground
  module Generators
    module Domain
    # HecksPlayground::Generators::Domain::SpecificationGenerator
    #
    ...
    #
    # The HecksPlayground::Specification mixin is injected at load time by InMemoryLoader
    ...
    class SpecificationGenerator
      ...
      def initialize(specification, domain_module:, aggregate_name:, mixin_prefix: "HecksPlayground")
      ...
      def call_body
        HecksPlayground::Utils.block_source(@specification.block)
      end
    end
    end
  end
