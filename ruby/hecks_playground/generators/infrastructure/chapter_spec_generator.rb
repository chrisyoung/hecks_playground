# HecksPlayground::Generators::ChapterSpecGenerator
#
...
#
#   gen = ChapterSpecGenerator.new(HecksPlayground::Runtime)  # loads from runtime.bluebook
...
module HecksPlayground
  module Generators
    class ChapterSpecGenerator < HecksPlayground::Generator
      # @param chapter_module [Module] a HecksPlayground::* module
      ...
      def chapter_require = "hecks_playground/chapters/#{chapter_slug}"
      ...
      def paragraph_aggregate_names
        @paragraph_aggregate_names ||= paragraphs.flat_map { |_, mod|
          b = HecksPlayground::DSL::BluebookBuilder.new("_probe")
          mod.define(b)
      ...
      def build_spec_string(describe_const, require_path, aggregates, domain_name, total_count: nil)
        ...
        lines << "  subject(:domain) { HecksPlayground::Chapters.definition_from_bluebook(\"#{chapter_slug}\") }"
        lines << ""
