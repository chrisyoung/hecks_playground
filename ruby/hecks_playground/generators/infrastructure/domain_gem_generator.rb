...
module HecksPlayground
  module Generators
    ...
    # HecksPlayground::Generators::Infrastructure::DomainGemGenerator
    #
    ...
    # the CLI `hecks_playground build` command and `HecksPlayground.build`.
    #
    #   gen = DomainGemGenerator.new(domain, output_dir: "./generated")
    #   gen.generate  # => path to generated gem root
    #
    class DomainGemGenerator < HecksPlayground::Generator
      include FileWriter
