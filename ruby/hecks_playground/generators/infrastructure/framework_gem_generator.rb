...
module HecksPlayground
  module Generators
    module Infrastructure
      # HecksPlayground::Generators::Infrastructure::FrameworkGemGenerator
      #
      ...
      #
      #   domain = HecksPlayground::Chapters.definition_from_bluebook("hecksagon")
      ...
      class FrameworkGemGenerator
        ...
        def entry_point_skeleton(name)
          mod = HecksPlayground::Utils.sanitize_constant(name)
          lines = []
          lines << "# #{mod}"
          lines << "#"
