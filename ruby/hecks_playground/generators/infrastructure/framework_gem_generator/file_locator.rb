  ...
  module Generators
    module Infrastructure
      class FrameworkGemGenerator
        # HecksPlayground::Generators::Infrastructure::FrameworkGemGenerator::FileLocator
        #
        ...
        #   locator.locate("HecksSqlite")     # => "hecks_playground/extensions/sqlite.rb"
        ...
        class FileLocator
          ...
          def locate(aggregate_name)
            snake = HecksPlayground::Utils.underscore(aggregate_name)

            # Exact basename match
            return @index[snake] if @index[snake]

            # Strip "hecks_playground_" prefix (e.g., HecksCqrs → cqrs)
