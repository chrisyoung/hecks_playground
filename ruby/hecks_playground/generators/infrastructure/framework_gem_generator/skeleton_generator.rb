  ...
  module Generators
    module Infrastructure
      class FrameworkGemGenerator
        # HecksPlayground::Generators::Infrastructure::FrameworkGemGenerator::SkeletonGenerator
        #
        ...
        class SkeletonGenerator
          ...
          def use_class?
            ...
            return false if name.end_with?("DSL", "Mixin", "Helpers", "Registry",
                                           "Boot", "Setup")
            return false if name.start_with?("HecksPlayground") && !name.include?("::")
          ...
          def method_stubs
            ...
            @aggregate.commands.each do |cmd|
              method = cmd.method_name || HecksPlayground::Utils.underscore(cmd.name)
