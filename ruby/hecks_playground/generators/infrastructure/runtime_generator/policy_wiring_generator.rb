# HecksPlayground::Generators::Infrastructure::PolicyWiringGenerator
#
...
module HecksPlayground
  module Generators
    module Infrastructure
      class PolicyWiringGenerator < HecksPlayground::Generator
        ...
        def helper_lines
          ...
          lines << '            warn "[HecksPlayground] Policy #{policy.name} failed: #{e.message}"'
          lines << "          ensure"
