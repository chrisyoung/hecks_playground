module HecksPlayground
  module Generators
    ...
    # HecksPlayground::Generators::Infrastructure::PortWiringGenerator
    #
    ...
    # HecksPlayground::Runtime::PortSetup mixin which iterates the domain IR at boot
    ...
    #   # => "module HecksPlayground\n  class Runtime\n    module Generated\n      module PortWiring\n  ..."
    #
    class PortWiringGenerator < HecksPlayground::Generator
      ...
      #
      # Produces a module under +HecksPlayground::Runtime::Generated+ containing:
      ...
      def ownership_scoped_repo_lines
        [
          ...
          '            require "hecks_playground/extensions/tenancy_support/ownership_scoped_repository"',
          '            HecksTenancy::OwnershipScopedRepository.new(',
          '              repo,',
          '              ownership_field: gate_def.ownership_field,',
          '              identity_source: -> { HecksPlayground.current_user }',
          '            )',
          ...
          '              identity_source: -> { HecksPlayground.tenant }',
          '            )',
          '          else',
          '            repo',
          '          end',
