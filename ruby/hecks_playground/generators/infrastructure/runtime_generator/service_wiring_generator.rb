module HecksPlayground
  module Generators
    ...
    # HecksPlayground::Generators::Infrastructure::ServiceWiringGenerator
    #
    ...
    # HecksPlayground::ServiceSetup mixin which iterates the domain IR at boot time.
    ...
    #
    class ServiceWiringGenerator < HecksPlayground::Generator
      ...
      #
      # Produces a module under +HecksPlayground::Runtime::Generated+ containing a
      ...
      #
      # @return [Array<HecksPlayground::BluebookModel::Behavior::Service>] domain services
      def services
        @domain.services || []
      end
      ...
      #
      # @param svc [HecksPlayground::BluebookModel::Behavior::Service] the service to wire
      ...
      def service_lines(svc)
        ...
        call_body_source = svc.call_body ? HecksPlayground::Utils.block_source(svc.call_body) : nil

        lines = []
        lines << "          mod.define_singleton_method(:#{method_name}) do |**kwargs|"
        lines << "            attr_names = [#{attr_names.join(', ')}]"
        lines << "            ctx = HecksPlayground::ServiceContext.new(command_bus, attr_names, kwargs)"
        if call_body_source
