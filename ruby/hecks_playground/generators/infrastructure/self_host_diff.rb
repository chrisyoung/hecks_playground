...
module HecksPlayground
  module Generators
    module Infrastructure
      # HecksPlayground::Generators::Infrastructure::SelfHostDiff
      #
      ...
      #
      class SelfHostDiff
        # HecksPlayground::Generators::Infrastructure::SelfHostDiff::Entry
        #
        ...
        def generate_domain
          files = {}
          Dir.mktmpdir("hecks_playground_self_diff") do |tmpdir|
        ...
        def generate_framework
          Dir.mktmpdir("hecks_playground_fw_diff") do |tmpdir|
