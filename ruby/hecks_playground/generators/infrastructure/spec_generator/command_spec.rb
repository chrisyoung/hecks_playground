  ...
  module Generators
    module Infrastructure
      class SpecGenerator < HecksPlayground::Generator
        # HecksPlayground::Generators::Infrastructure::SpecGenerator::CommandSpec
        #
        ...
        module CommandSpec
          ...
          #
          # @param command [HecksPlayground::BluebookModel::Behavior::Command] the command IR
          # @param aggregate [HecksPlayground::BluebookModel::Structure::Aggregate] the owning
