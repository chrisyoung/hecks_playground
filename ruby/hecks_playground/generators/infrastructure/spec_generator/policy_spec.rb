# HecksPlayground::Generators::Infrastructure::SpecGenerator::PolicySpec
#
    ...
    module Infrastructure
      class SpecGenerator < HecksPlayground::Generator
        module PolicySpec
          ...
          #
          # @param policy [HecksPlayground::BluebookModel::Behavior::Policy] the policy IR
          # @param aggregate [HecksPlayground::BluebookModel::Structure::Aggregate] the owning aggregate
          ...
          def generate_policy_spec(policy, aggregate)
            ...
            lines << "  before { @app = HecksPlayground.load(domain, force: true) }"
            lines << ""
          ...
          def is_update_cmd?(cmd, agg)
            HecksPlayground::Conventions::CommandContract.find_self_ref(cmd.attributes, agg.name) != nil
          end
          ...
          def update_args_for(cmd, agg)
            self_ref = HecksPlayground::Conventions::CommandContract.find_self_ref(cmd.attributes, agg.name)
