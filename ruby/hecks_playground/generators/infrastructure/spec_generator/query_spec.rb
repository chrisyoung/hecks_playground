# HecksPlayground::Generators::Infrastructure::SpecGenerator::QuerySpec
#
    ...
    module Infrastructure
      class SpecGenerator < HecksPlayground::Generator
        module QuerySpec
          ...
          #
          # @param query [HecksPlayground::BluebookModel::Behavior::Query] the query IR
          ...
          def command_method_name(cmd, aggregate)
            HecksPlayground::Conventions::CommandContract.method_name(cmd.name, aggregate.name).to_s
          end
