# HecksPlayground::Generators::Registry
#
...
#
#   HecksPlayground::Generators.register(:aggregate, Generators::Domain::AggregateGenerator)
#   HecksPlayground::Generators.register(:value_object, Generators::Domain::ValueObjectGenerator, scope: :child)
#   HecksPlayground::Generators.register(:workflow, Generators::Domain::WorkflowGenerator, scope: :domain)
#
require "hecks_playground/generator"
...
module HecksPlayground
  module Generators
    ...
    # @param mixin [String, nil] mixin to inject after class definition (e.g., "HecksPlayground::Command")
