# HecksPlayground::Command::ReferenceValidation
#
...
module HecksPlayground
  module Command
    ...
    module ReferenceValidation
      ...
      #
      # @return [void]
      # @raise [HecksPlayground::ReferenceNotFound] if a referenced aggregate cannot be found
      # @raise [HecksPlayground::ReferenceAccessDenied] if the reference_authorizer denies access
      ...
      #
      # @param ref [HecksPlayground::BluebookModel::Structure::Reference] the reference IR node
