# HecksPlayground::Command::Validation
# Pre/postcondition DSL and enforcement for command objects.
# Included automatically via HecksPlayground::Command.
#
# Usage:
#   class CreatePost
#     include HecksPlayground::Command
...
module HecksPlayground
  module Command
    # HecksPlayground::Command::Validation
    #
    # Pre/postcondition DSL and enforcement for command objects, included automatically via HecksPlayground::Command.
    #
    module Validation
      ...
      module ClassMethods
        ...
        # @return [void]
        # @raise [HecksPlayground::PreconditionError] at execution time if the block returns falsey
        ...
        # @return [void]
        # @raise [HecksPlayground::PostconditionError] at execution time if the block returns falsey
      ...
      # Raises +HecksPlayground::PreconditionError+ on the first failure.
      #
      # @return [void]
      # @raise [HecksPlayground::PreconditionError] if any precondition block returns falsey
      def check_preconditions
        self.class.preconditions.each do |cond|
          unless instance_exec(&cond.block)
            raise HecksPlayground::PreconditionError, "Precondition failed: #{cond.message}"
          end
        end
      end
      ...
      # @return [void]
      # @raise [HecksPlayground::PostconditionError] if any postcondition block returns falsey
      def check_postconditions(before, after)
        self.class.postconditions.each do |cond|
          unless cond.block.call(before, after)
            raise HecksPlayground::PostconditionError, "Postcondition failed: #{cond.message}"
          end
        end
      end
