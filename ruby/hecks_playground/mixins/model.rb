...
HecksPlayground::Chapters.load_aggregates(
  ...
  #
  #   class Pizza
  #     include HecksPlayground::Model
  #     attribute :name
  #     attribute :description
  #     attribute :toppings, default: []
  #   end
  #
  #   Pizza.hecks_playground_attributes  # => [{name: :name, default: nil}, ...]
...
module HecksPlayground
  ...
  module Model
    ...
    # Hook called when a class includes +HecksPlayground::Model+. Sets up identity readers
    ...
    module ClassMethods
      ...
      def attribute(name, default: nil, freeze: false)
        @hecks_playground_attributes ||= []
        @hecks_playground_attributes << RuntimeAttributeDefinition.new(name: name.to_sym, default: default, freeze: freeze)
        attr_reader name
        attr_writer name
        rebuild_initializer
      end
      ...
      def hecks_playground_attributes
        @hecks_playground_attributes || []
      end
      ...
      def rebuild_initializer
        attrs = @hecks_playground_attributes.dup
    ...
    def inspect
      ...
      attrs = self.class.hecks_playground_attributes.map do |attr|
    ...
    MIXINS = {
      Commands:       -> { HecksPlayground::Command },
      Queries:        -> { HecksPlayground::Query },
      Specifications: -> { HecksPlayground::Specification },
    }.freeze
