...
module HecksPlayground
  ...
  #
  module Query
    # Hook called when a class includes +HecksPlayground::Query+. Extends the class
    ...
    module ClassMethods
      ...
      #   The repository to query against, wired by the HecksPlayground runtime during boot.
