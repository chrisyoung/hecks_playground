...
module HecksPlayground
  ...
  #
  module Commands
      autoload :CommandResolver, "hecks_playground/ports/commands/command_resolver"
      autoload :CommandBus,     "hecks_playground/ports/commands/command_bus"
      autoload :CommandRunner,  "hecks_playground/ports/commands/command_runner"
      autoload :CommandMethods, "hecks_playground/ports/commands/command_methods"

      # Wires command infrastructure onto an aggregate class.
      #
      # Delegates to CommandMethods.bind, which auto-includes the HecksPlayground::Command
      ...
      # @param bus [HecksPlayground::Commands::CommandBus] the command bus for middleware dispatch
      ...
      # @yieldparam cmd [HecksPlayground::BluebookModel::Behavior::Command] the command definition
