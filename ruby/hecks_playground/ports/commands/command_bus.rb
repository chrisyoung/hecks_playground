...
module HecksPlayground
  module Commands
    # HecksPlayground::Commands::CommandBus
    #
    ...
    class CommandBus
      ...
      #
      # @param domain [HecksPlayground::BluebookModel::Structure::Domain] the domain IR containing
      #   aggregate, command, and event definitions
      # @param event_bus [HecksPlayground::EventBus] the event bus for publishing domain events
      ...
      #
      # This is used by the HecksPlayground::Command mixin when executing commands
