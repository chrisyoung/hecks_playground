module HecksPlayground
  module Commands
    # HecksPlayground::Commands::CommandMethods
    #
    ...
    module CommandMethods
      ...
      # 1. Auto-includes the HecksPlayground::Command mixin if not already present
      ...
      # @param bus [HecksPlayground::Commands::CommandBus] the command bus (used for middleware dispatch
      ...
      def self.bind(klass, aggregate, bus, repo, defaults)
        ...
        aggregate.commands.each do |cmd|
          ...
          cmd_class.include(HecksPlayground::Command) unless cmd_class < HecksPlayground::Command
      ...
      # @param aggregate [HecksPlayground::BluebookModel::Structure::Aggregate] the aggregate definition
      ...
      def self.bind_shortcuts(klass, aggregate)
        aggregate.commands.each do |cmd|
          executor = yield(cmd)
          method_name = HecksPlayground::Conventions::CommandContract.method_name(cmd.name, aggregate.name)
