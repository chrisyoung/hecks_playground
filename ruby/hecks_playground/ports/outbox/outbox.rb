...
module HecksPlayground
  ...
  #
  module Outbox
    autoload :MemoryOutbox,  "hecks_playground/ports/outbox/memory_outbox"
    autoload :OutboxPoller,  "hecks_playground/ports/outbox/outbox_poller"
  end
end
