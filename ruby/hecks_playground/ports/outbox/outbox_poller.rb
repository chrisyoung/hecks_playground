# HecksPlayground::Outbox::OutboxPoller
#
...
# == Usage
#
#   poller = HecksPlayground::Outbox::OutboxPoller.new(outbox, event_bus)
...
module HecksPlayground
  module Outbox
    ...
    class OutboxPoller
      ...
      # @return [HecksPlayground::EventBus] the event bus reference
      attr_reader :event_bus

      # Creates a new poller wired to an outbox and event bus.
      #
      # @param outbox [HecksPlayground::Outbox::MemoryOutbox] the outbox to poll
      # @param event_bus [HecksPlayground::EventBus] the event bus to publish to
