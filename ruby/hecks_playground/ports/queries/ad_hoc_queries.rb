module HecksPlayground
  module Querying
    # HecksPlayground::Querying::AdHocQueries
    #
    ...
    # == Usage
    #
    #   HecksPlayground::Querying::AdHocQueries.bind(Pizza, repo)
    #
    ...
    module AdHocQueries
      ...
      def self.bind(klass, repo)
        ...
        # @return [HecksPlayground::Querying::QueryBuilder] a chainable query
