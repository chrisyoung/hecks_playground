module HecksPlayground
  module Querying
    # HecksPlayground::Querying::ScopeMethods
    #
    ...
    module ScopeMethods
        ...
        #   must have +@__hecks_playground_repo__+ set (done by AdHocQueries.bind)
        ...
        def self.bind(klass, aggregate)
          aggregate.scopes.each do |scope|
            repo = klass.instance_variable_get(:@__hecks_playground_repo__)
            if scope.callable?
