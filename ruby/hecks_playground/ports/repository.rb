  # HecksPlayground::Persistence
  #
  # The top-level module for all persistence-related concerns in the HecksPlayground framework.
...
module HecksPlayground
  ...
  #
  module Persistence
      autoload :RepositoryMethods, "hecks_playground/ports/repository/repository_methods"
      autoload :CollectionMethods, "hecks_playground/ports/repository/collection_methods"
      autoload :CollectionProxy,   "hecks_playground/ports/repository/collection_proxy"
      autoload :CollectionItem,    "hecks_playground/ports/repository/collection_item"
      autoload :ReferenceMethods,  "hecks_playground/ports/repository/reference_methods"
      autoload :EventRecorder,    "hecks_playground/ports/repository/event_recorder"
      ...
      # @param aggregate [HecksPlayground::BluebookModel::Aggregate] the domain model metadata
      ...
      #
      # @param klass [Class] the aggregate class to augment (e.g., Pizza)
      # @param recorder [HecksPlayground::Persistence::EventRecorder] the event recorder
      #   instance backed by a SQL events table
      # @return [void]
      def self.bind_event_recorder(klass, recorder)
        agg_type = klass.name.split("::").last
        klass.define_singleton_method(:__hecks_playground_event_recorder__) { recorder }
