HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Runtime::PortInternals,
  base_dir: __dir__
)

module HecksPlayground
  module Persistence
    # HecksPlayground::Persistence::CollectionProxy
    #
    ...
    class CollectionProxy
        ...
        # @return [HecksPlayground::Persistence::CollectionItem] the newly created item wrapped
        ...
        #
        # @param item [Object, HecksPlayground::Persistence::CollectionItem] the item to remove
        ...
        #
        # @return [HecksPlayground::Persistence::CollectionProxy] self, now empty
        def clear
          rebuild_owner([])
          self
        end
        ...
        #
        # @yield [HecksPlayground::Persistence::CollectionItem] each item in the collection
        # @return [void]
        def each(&block)
        ...
        #
        # @return [HecksPlayground::Persistence::CollectionItem, nil] the first item or nil
        def first
          item = @items.first
          item ? wrap(item) : nil
        end
        ...
        #
        # @return [HecksPlayground::Persistence::CollectionItem, nil] the last item or nil
        def last
          item = @items.last
          item ? wrap(item) : nil
        end
        ...
        # @return [HecksPlayground::Persistence::CollectionItem, nil] the item at the index or nil
        def [](index)
          item = @items[index]
          item ? wrap(item) : nil
        end
        ...
        #
        # @return [Array<HecksPlayground::Persistence::CollectionItem>] all items wrapped
        def to_a
        ...
        # @return [HecksPlayground::Persistence::CollectionItem] the wrapped item
        def wrap(item)
        ...
        def rebuild_owner(new_items)
          attrs = { id: @owner.id }
          if @owner.class.respond_to?(:hecks_playground_attributes)
            @owner.class.hecks_playground_attributes.each do |hattr|
