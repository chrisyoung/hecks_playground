# HecksPlayground::BluebookRegistryMethods
#
...
module HecksPlayground
  # HecksPlayground::BluebookRegistryMethods
  #
  # Domain caching, load strategy, and last_domain tracking extended onto the HecksPlayground module.
  #
  module BluebookRegistryMethods
    ...
    # Most recently parsed .fixtures file. Set by HecksPlayground.fixtures.
