# HecksPlayground::CapabilityRegistryMethods
#
...
#
#   HecksPlayground.register_capability(:crud) { |runtime| CrudCapability.apply(runtime) }
#   HecksPlayground.describe_capability(:websocket, config: { port: { default: 4568, desc: "WebSocket port" } })
#   HecksPlayground.capability_registry  # => { crud: #<Proc> }
#   HecksPlayground.capability_config(:websocket) # => { port: { default: 4568, desc: "..." } }
#
