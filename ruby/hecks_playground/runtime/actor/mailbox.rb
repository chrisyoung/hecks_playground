# HecksPlayground::Runtime::Actor::Mailbox
#
      ...
      class Mailbox
        ...
        def tell(command_name, **args)
          ...
          @queue << { command: command_name, args: args, callback: nil,
                      role: HecksPlayground.current_role, actor: HecksPlayground.actor }
        end
        ...
        def process(msg)
          HecksPlayground.current_role = msg[:role]
          HecksPlayground.actor = msg[:actor]
