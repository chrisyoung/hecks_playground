# HecksPlayground::AggregateDescriber
#
...
#
#   lines = HecksPlayground::AggregateDescriber.describe_lines(aggregate)
#   puts lines.join("\n")
#
  ...
  module AggregateDescriber
    ...
    def self.attributes_section(agg)
      ...
      agg.attributes.each do |attr|
        lines << "    #{attr.name}: #{HecksPlayground::Utils.type_label(attr)}"
      end
      lines
    end
