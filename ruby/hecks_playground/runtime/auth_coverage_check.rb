# HecksPlayground::Runtime::AuthCoverageCheck
#
...
# security gaps.
#
#   # Automatically called after extensions fire during HecksPlayground.boot
...
module HecksPlayground
  class Runtime
    ...
    module AuthCoverageCheck
      ...
      #
      # Raises +HecksPlayground::ConfigurationError+ if actor-protected commands
      # exist but no +:auth+ middleware is registered.
      #
      # @return [void]
      # @raise [HecksPlayground::ConfigurationError] when actors declared without auth
      def check_auth_coverage!
        ...
        raise HecksPlayground::ConfigurationError,
          ...
          "HecksPlayground.boot or HecksPlayground.configure block, or explicitly opt out " \
      ...
      #
      # @return [Array<HecksPlayground::BluebookModel::Structure::Command>] commands with actors
