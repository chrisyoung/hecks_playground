# HecksPlayground::Runtime::CommandDispatch
#
...
module HecksPlayground
  class Runtime
    ...
    module CommandDispatch
      ...
      # @param attrs [Hash] the command attributes
      # @return [HecksPlayground::DryRunResult]
      ...
      def trace_reactive_chain(command_name)
        return [] unless defined?(HecksPlayground::FlowGenerator)
        flows = HecksPlayground::FlowGenerator.new(@domain).trace_flows
