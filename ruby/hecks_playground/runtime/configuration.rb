require "fileutils"
require "hecks_playground_persist/database_connection"
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Runtime::Setup,
  base_dir: File.expand_path("configuration", __dir__)
)
require "hecks_playground_persist/sql_setup"
  # HecksPlayground::Configuration
  #
  # Wires HecksPlayground into an application. Supports single or multiple domains with
...
module HecksPlayground
  # HecksPlayground::Configuration
  #
  # Wires HecksPlayground into an application supporting single or multiple domains with pluggable adapters and extensions.
  #
  class Configuration
    ...
    def auto_wire(except: [], only: nil)
      ...
      HecksPlayground.extension_registry.each_key do |name|
        next if HecksPlayground.adapter?(name)
    ...
    def activate_rails
      ...
      # active_hecks_playground gem not installed
    end
  end
end
