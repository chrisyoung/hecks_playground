...
# HecksPlayground::Configuration::DomainLoader
#
...
module HecksPlayground
  class Configuration
    ...
    # from a local path, the domain gem is built on the fly via +HecksPlayground.build+
    ...
    module DomainLoader
      ...
      # @return [Array(HecksPlayground::BluebookModel::Structure::Domain, Module)] tuple of domain IR and domain module
      def load_domain(d)
      ...
      # Evaluates +Bluebook+, builds the gem via +HecksPlayground.build+, adds the
      ...
      def load_from_path(d)
        ...
        domain_obj = HecksPlayground.last_domain
        domain_obj.source_path = domain_file

        gem_path = HecksPlayground.build(domain_obj, output_dir: base)
