# HecksPlayground::Runtime::ConstantHoisting
#
      ...
      module ConstantHoisting
        ...
        def hoist_constants
          ...
          @domain.aggregates.each do |agg|
            ...
            HecksPlayground::Utils.remove_constant(name) if Object.const_defined?(name, false)
          ...
          mod.define_singleton_method(:unload!) do
            hoisted.each { |name| HecksPlayground::Utils.remove_constant(name) }
            HecksPlayground::Utils.remove_constant(mod_name)
          end
        end
      end
  end
