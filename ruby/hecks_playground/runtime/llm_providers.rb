module HecksPlayground
  class Runtime
    ...
    #
    # Providers raise HecksPlayground::LlmAdapterError on transport / parse / auth
    # failures. The dispatcher catches that and re-raises as the
    # structured HecksPlayground::LlmInvocationFailed.
    #
...
require "hecks_playground/runtime/llm_providers/test_provider"
