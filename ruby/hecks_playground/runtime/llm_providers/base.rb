# HecksPlayground::Runtime::LlmProviders — namespace + sibling stubs
#
# Phase 2 step 5 (this file) defines:
#   - The shared Result struct returned by every provider's #invoke
#   - The HecksPlayground::LlmAdapterError raised on transport failure
...
#   )
#
#   class HecksPlayground::LlmAdapterError < StandardError; end
#   class HecksPlayground::LlmInvocationSkipped < HecksPlayground::LlmAdapterError
#     attr_reader :reason
...
module HecksPlayground
  unless defined?(HecksPlayground::LlmAdapterError)
  ...
  unless defined?(HecksPlayground::LlmInvocationSkipped)
    ...
    class LlmInvocationSkipped < HecksPlayground::LlmAdapterError
      attr_reader :reason
  ...
  class Runtime
    # HecksPlayground::Runtime::LlmProviders
    #
    ...
    #
    module LlmProviders
      unless defined?(HecksPlayground::Runtime::LlmProviders::Result)
        Result = Struct.new(
          :response_text, :tokens_in, :tokens_out, :model_used, :raw,
          keyword_init: true
        )
