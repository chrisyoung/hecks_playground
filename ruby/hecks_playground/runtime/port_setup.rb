module HecksPlayground
  class Runtime
    # HecksPlayground::Runtime::PortSetup
    #
    ...
    module PortSetup
      ...
      # - Introspection (hecks_playground_attributes, hecks_playground_aggregate) for reflection
      ...
      #
      # @param agg [HecksPlayground::BluebookModel::Aggregate] the aggregate definition from the domain model
      # @return [void]
      ...
      #
      # @param agg [HecksPlayground::BluebookModel::Aggregate] the aggregate definition
