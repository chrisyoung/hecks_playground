# HecksPlayground::Runtime::ProcessManagerSetup
#
# Mixin that wires process_manager declarations from the bluebook DSL
# into live HecksPlayground::EventSourcing::ProcessManager instances at boot time.
...
module HecksPlayground
  class Runtime
    ...
    module ProcessManagerSetup
      ...
      # at spec/hecks_playground/runtime/process_manager_setup_spec.rb exercises
      # both paths.
      #
      # @return [void]
      def setup_process_managers
        ...
        @domain.process_managers.each do |pm_ir|
          pm = HecksPlayground::EventSourcing::ProcessManager.new(
            name: pm_ir.name,
            store: @saga_store
          )
      ...
      #
      # @param pm [HecksPlayground::EventSourcing::ProcessManager]
      # @param pm_ir [HecksPlayground::BluebookModel::Behavior::ProcessManager]
      # @return [void]
