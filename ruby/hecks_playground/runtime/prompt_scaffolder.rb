...
module HecksPlayground
  class Runtime
    ...
    # HecksPlayground::Runtime::PromptScaffolder
    #
    ...
    module PromptScaffolder
      ...
      #
      # @param command [HecksPlayground::BluebookModel::Behavior::Command, nil]
      # @param aggregate [HecksPlayground::BluebookModel::Structure::Aggregate, nil]
