...
module HecksPlayground
  ...
  #
  class SagaRunner
    # @return [HecksPlayground::BluebookModel::Behavior::Saga] the saga definition
    attr_reader :saga

    # Creates a new runner for the given saga definition.
    #
    # @param saga [HecksPlayground::BluebookModel::Behavior::Saga] the saga IR
    # @param command_bus [HecksPlayground::Commands::CommandBus] for dispatching commands
    # @param store [HecksPlayground::SagaStore] for persisting saga state
    # @param event_bus [HecksPlayground::EventBus] for publishing saga lifecycle events
