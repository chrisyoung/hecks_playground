...
module HecksPlayground
  ...
  module ServiceSetup
    ...
    # method on +mod+.
    #
    # @param domain [HecksPlayground::BluebookModel::Domain] the domain definition containing service declarations
    # @param mod [Module] the domain module to define service methods on (e.g., +BankingDomain+)
    # @param command_bus [HecksPlayground::CommandBus] the command bus for dispatching commands within service bodies
    # @return [void]
    ...
    #
    # @param svc [HecksPlayground::BluebookModel::Service] the service definition from the DSL
    # @param mod [Module] the domain module to define the method on
    # @param command_bus [HecksPlayground::CommandBus] the command bus for the service context
    # @return [void]
  ...
  class ServiceContext
    ...
    #
    # @param command_bus [HecksPlayground::CommandBus] the command bus to dispatch commands through
