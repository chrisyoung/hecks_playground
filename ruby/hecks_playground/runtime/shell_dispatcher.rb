...
module HecksPlayground
  class Runtime
    ...
    # HecksPlayground::Runtime::ShellDispatcher
    #
    ...
    module ShellDispatcher
      ...
      # @return [Result]
      # @raise [HecksPlayground::ShellAdapterError] if exit status is non-zero (except :exit_code format)
      # @raise [HecksPlayground::ShellAdapterTimeoutError] if adapter.timeout is exceeded
      ...
      def run(adapter, args)
        ...
        if exit_status != 0 && adapter.output_format != :exit_code
          ...
          raise HecksPlayground::ShellAdapterError.new(
      ...
      def capture_with_timeout(adapter, env, args, chdir)
        ...
        until wait_thr.join(0.01)
          if Process.clock_gettime(Process::CLOCK_MONOTONIC) >= deadline
            ...
            raise HecksPlayground::ShellAdapterTimeoutError.new(
