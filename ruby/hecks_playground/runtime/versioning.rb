...
module HecksPlayground
  ...
  module Versioning
    ...
    # state (all +hecks_playground_attributes+) before persisting the update. Each snapshot
    ...
    def self.bind(klass, repo)
      ...
      repo.define_singleton_method(:save) do |aggregate|
        ...
        if existing
          ...
          snapshot = {}
          klass.hecks_playground_attributes.each do |attr_def|
