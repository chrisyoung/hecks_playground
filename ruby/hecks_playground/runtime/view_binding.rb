...
module HecksPlayground
  ...
  class ViewBinding
    ...
    #
    # @param view [HecksPlayground::BluebookModel::View] the view definition containing projections
    # @param event_bus [HecksPlayground::EventBus] the event bus to subscribe projections to
