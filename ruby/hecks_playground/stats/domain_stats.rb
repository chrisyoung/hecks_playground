  # HecksPlayground::Stats::DomainStats
  #
  # Collects metrics for a single HecksPlayground domain.
  #
  #   stats = DomainStats.new(domain)
  #   stats.to_h[:aggregates]  # => 5
  #   stats.to_h[:commands]    # => 14
  #
module HecksPlayground::Stats

  # HecksPlayground::Stats::DomainStats
  #
  # Collects aggregate, command, event, and policy metrics for a single HecksPlayground domain.
  #
  class DomainStats
