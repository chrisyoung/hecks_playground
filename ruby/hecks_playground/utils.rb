  # = HecksPlayground::Utils
  #
  # Shared utility functions used across the HecksPlayground framework. Provides constant
  ...
  # either +HecksPlayground::Utils.underscore(str)+ or included into a class.
  #
  ...
  # == Usage
  #
  #   HecksPlayground::Utils.sanitize_constant("My Pizza")  # => "MyPizza"
  #   HecksPlayground::Utils.underscore("PizzaDomain")       # => "pizza_domain"
  #   HecksPlayground::Utils.ruby_keyword?("class")          # => true
  #
module HecksPlayground
  ...
  module Utils
    ...
    # Returns the attribute names for a HecksPlayground domain object. Prefers
    # the +hecks_playground_attributes+ class method (set by the Model mixin) for
    # accurate metadata. Falls back to introspecting +initialize+ parameters
    # if +hecks_playground_attributes+ is not available.
    #
    ...
    def object_attr_names(obj)
      ...
      if klass.respond_to?(:hecks_playground_attributes)
        names += klass.hecks_playground_attributes.map(&:name)
      else
    ...
    # Serializes a HecksPlayground domain object to a Hash using its attribute metadata.
    ...
    #   HecksPlayground::Utils.serialize_object(pizza)
    ...
    # +HecksPlayground::PathTraversalDetected+ if the resolved path escapes the root.
    ...
    # @raise [HecksPlayground::PathTraversalDetected] if the path escapes root or contains
    #   a null byte
    #
    # @example
    #   HecksPlayground::Utils.safe_path!("/tmp/out", "lib/pizza.rb")
    #   # => "/tmp/out/lib/pizza.rb"
    #
    #   HecksPlayground::Utils.safe_path!("/tmp/out", "../etc/passwd")
    #   # raises HecksPlayground::PathTraversalDetected
    ...
    #
    #   HecksPlayground::Utils.remove_constant(:PizzasDomain)
    #
    ...
    #
    #   HecksPlayground::Utils.track_constant(:PizzasDomain)
    #
