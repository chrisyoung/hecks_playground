...
#
#   result = HecksPlayground::Validate.run("/path/to/project")
#   result[:errors]    # => []
  ...
  module Validate
    def self.run(dir, format: "text")
      ...
      paths.each do |path|
        ...
        begin
          result = HecksPlayground.boot(path)
    ...
    def self.discover(dir)
      Dir.glob(File.join(dir, "**/hecks_playground/*.bluebook"))
    ...
    def self.ul_coverage(runtime, project_path = nil)
      ...
      require "hecks_playground/tag_scanner"
