module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::BaseRule
    #
    ...
    #
    # Rules are collected and executed by +HecksPlayground.validate+ during domain compilation
    ...
    class BaseRule
      ...
      #
      # @param domain [HecksPlayground::BluebookModel::Structure::Domain] the domain model containing
