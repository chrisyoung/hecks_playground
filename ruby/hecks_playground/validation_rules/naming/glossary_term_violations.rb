module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::Naming::GlossaryTermViolations
    #
    ...
    #
    # Usage:
    #   HecksPlayground.bluebook "Billing" do
    ...
    HecksPlayground.register_validation_rule(GlossaryTermViolations)
    end
  end
end
