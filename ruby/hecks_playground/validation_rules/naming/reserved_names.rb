module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::Naming::ReservedNames
    #
    ...
    class ReservedNames < BaseRule
      ...
      # +HecksPlayground::Model+, so declaring them explicitly may cause unexpected
      # behavior. Called by +HecksPlayground.build+ to emit non-blocking warnings.
      #
      ...
      def self.reserved_attr_warnings(domain)
        ...
        domain.aggregates.each do |agg|
          agg.attributes.each do |attr|
            if HecksPlayground::Utils::RESERVED_AGGREGATE_ATTRS.include?(attr.name.to_s)
      ...
      def check_keyword_attrs(agg)
        errs = []
        agg.attributes.each do |attr|
          if HecksPlayground::Utils.ruby_keyword?(attr.name.to_s)
    ...
    HecksPlayground.register_validation_rule(ReservedNames)
    end
  end
end
