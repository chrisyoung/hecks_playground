module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::Naming::SafeIdentifierNames
    #
    ...
    class SafeIdentifierNames < BaseRule
      ...
      #
      # @param agg [HecksPlayground::BluebookModel::Structure::Aggregate] the aggregate to check
      ...
      #
      # @param attr [HecksPlayground::BluebookModel::Structure::Attribute] the attribute to check
      # @param context [String] the context label for the error message
    ...
    HecksPlayground.register_validation_rule(SafeIdentifierNames)
    end
  end
end
