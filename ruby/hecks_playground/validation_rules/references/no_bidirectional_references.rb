module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::References::NoBidirectionalReferences
    #
    ...
    #
    # Part of the ValidationRules::References group -- run by +HecksPlayground.validate+.
    #
    ...
    HecksPlayground.register_validation_rule(NoBidirectionalReferences)
    end
  end
end
