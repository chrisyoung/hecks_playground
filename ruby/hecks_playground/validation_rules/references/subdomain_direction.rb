# HecksPlayground::ValidationRules::References::SubdomainDirection
#
  ...
  module ValidationRules
    module References
      class SubdomainDirection < BaseRule
        ...
        def multi_domain?
          HecksPlayground.respond_to?(:bluebook_objects) && HecksPlayground.bluebook_objects.respond_to?(:keys) && HecksPlayground.bluebook_objects.keys.size > 1
        end

        def build_subdomain_map
          map = {}
          HecksPlayground.bluebook_objects.each do |_mod, domain|
      ...
      HecksPlayground.register_validation_rule(SubdomainDirection)
    end
  end
end
