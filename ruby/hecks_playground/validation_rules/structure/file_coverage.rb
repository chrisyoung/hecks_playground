# HecksPlayground::ValidationRules::Structure::FileCoverage
#
  ...
  module ValidationRules
    ...
    class FileCoverage < BaseRule
      ...
      def project_root
        ...
        3.times do
          return path if File.exist?(File.join(path, "Gemfile")) || Dir.exist?(File.join(path, "hecks_playground"))
    ...
    HecksPlayground.register_validation_rule(FileCoverage)
    end
  end
end
