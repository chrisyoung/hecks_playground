module HecksPlayground
  module ValidationRules
    ...
    # HecksPlayground::ValidationRules::Structure::UnreachableLifecycleStates
    #
    ...
    #
    # Part of the ValidationRules::Structure group -- run by +HecksPlayground.validate+.
    #
    ...
    HecksPlayground.register_validation_rule(UnreachableLifecycleStates)
    end
  end
end
