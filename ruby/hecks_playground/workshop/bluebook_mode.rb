module HecksPlayground
  class Workshop
    ...
    # HecksPlayground::Workshop::BluebookMode
    #
    ...
    # chapters and boots them with a shared event bus via HecksPlayground.open.
    #
    #   workshop = HecksPlayground.workshop("PizzaShop")
