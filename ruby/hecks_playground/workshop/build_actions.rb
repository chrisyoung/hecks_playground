module HecksPlayground
  class Workshop
    # HecksPlayground::Workshop::BuildActions
    #
    ...
    module BuildActions
      ...
      # HecksPlayground validator. Prints a success summary (aggregate/command/event
      ...
      def preview(aggregate_name = nil)
        ...
        if aggregate_name
          puts HecksPlayground.preview(domain, aggregate_name)
        else
          domain.aggregates.each do |agg|
            puts "# === #{agg.name} ==="
            puts HecksPlayground.preview(domain, agg.name)
            puts
          end
        end
        nil
      ...
      def build(version: nil, output_dir: ".")
        ...
        path = HecksPlayground.build(domain, version: version, output_dir: output_dir)
