HecksPlayground::CLI.register_command(:web_workshop, "Start the browser-based workshop",
  args: ["NAME"],
  options: {
  ...
  HecksPlayground::Workshop::WebRunner.new(name: name, gate: port, domain: domain, enable_console: enable_console).run
end
