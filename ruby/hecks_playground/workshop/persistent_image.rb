# HecksPlayground::Workshop::PersistentImage
#
...
#
# Files are stored in a configurable directory (default: .hecks_playground/images/).
# Each file is named after the domain with a .heckimage extension.
#
#   workshop.save_image                     # saves to .hecks_playground/images/pizzas.heckimage
#   workshop.save_image("checkpoint")       # saves to .hecks_playground/images/checkpoint.heckimage
#   workshop.restore_image                  # restores from .hecks_playground/images/pizzas.heckimage
...
module HecksPlayground
  class Workshop
    module PersistentImage
      IMAGE_DIR = ".hecks_playground/images"
      IMAGE_EXT = ".heckimage"
      ...
      # @return [HecksPlayground::Workshop] self
      ...
      def write_image_file(path, image)
        content = []
        content << "# HecksPlayground Session Image"
