HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Workshop::SandboxParagraph,
  base_dir: File.expand_path("playground", __dir__)
)

module HecksPlayground
  class Workshop
    # HecksPlayground::Workshop::Playground
    #
    ...
    #
    #   playground = HecksPlayground::Workshop::Playground.new(domain)
    ...
    def events_of(type_name)
      @events.select { |e| HecksPlayground::Utils.const_short_name(e) == type_name }
    end
    ...
    def history
      ...
      @events.each_with_index do |event, i|
        name = HecksPlayground::Utils.const_short_name(event)
    ...
    #
    # @return [String] e.g. '#<HecksPlayground::Workshop::Playground "Pizzas" (3 events)>'
    def inspect
      "#<HecksPlayground::Workshop::Playground \"#{@domain.name}\" (#{@events.size} events)>"
    end
