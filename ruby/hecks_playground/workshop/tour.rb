...
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::Workshop::TourStepsParagraph,
...
module HecksPlayground
  class Workshop
    class Tour
      ...
      def start
        puts ""
        puts "=== HecksPlayground Workshop Tour ==="
        ...
        puts "Run `hecks_playground console` to start your own workshop."
        puts ""
        nil
      end
