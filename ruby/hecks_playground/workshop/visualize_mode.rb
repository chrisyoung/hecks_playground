module HecksPlayground
  class Workshop
    # HecksPlayground::Workshop::VisualizeMode
    #
    ...
    module VisualizeMode
      ...
      def mermaid_for(domain, type)
        case type
        when :structure
          "```mermaid\n#{HecksPlayground::DomainVisualizer.new(domain).send(:generate_structure)}\n```"
        when :behavior
          "```mermaid\n#{HecksPlayground::DomainVisualizer.new(domain).send(:generate_behavior)}\n```"
        when :flows
