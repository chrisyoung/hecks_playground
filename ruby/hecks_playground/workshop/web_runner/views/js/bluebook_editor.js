// HecksPlayground::Workshop::WebRunner — BluebookEditor
//
...
//   ed.content = 'HecksPlayground.domain "Pizzas" do\n  aggregate "Pizza" do\n  end\nend';
...
function _colorTokens(s) {
  ...
  // HecksPlayground namespace
  s = s.replace(/\bHecks\b/g, '<span class="ns">HecksPlayground</span>');
  // DSL keywords
  s = s.replace(
