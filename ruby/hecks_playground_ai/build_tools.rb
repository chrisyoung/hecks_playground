module HecksPlayground
  module MCP
    # HecksPlayground::MCP::BuildTools
    #
    ...
    module BuildTools
      ...
      # @param ctx [HecksPlayground::McpServer] shared context with session, capture_output
      # @return [void]
      def self.register(server, ctx)
        ...
        server.define_tool(
          ...
          port = args["port"] || 9292
          Thread.new { HecksPlayground::HTTP::DomainServer.new(domain, gate: port).run }
