# HecksPlayground::AI::BluebookBuilder
#
...
#   builder = HecksPlayground::AI::BluebookBuilder.new(json)
#   workshop = builder.build   # => HecksPlayground::Workshop
#   dsl = workshop.to_dsl      # => "HecksPlayground.domain \"Banking\" do ..."
#
module HecksPlayground
  module AI
    class BluebookBuilder
      ...
      #
      # @return [HecksPlayground::Workshop] the populated workshop
      ...
      def build
        ...
        @workshop = HecksPlayground.workshop(domain_name)
