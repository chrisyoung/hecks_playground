module HecksPlayground
  module MCP
    # HecksPlayground::MCP::DomainSerializer
    #
    # Serializes a HecksPlayground domain model into structured JSON for MCP tool responses.
    ...
    #   json = HecksPlayground::MCP::DomainSerializer.call(domain)
    #   # => { domain: "Pizzas", aggregates: [...], policies: [...], services: [...] }
    #
    module DomainSerializer
      # Serializes a full domain model into a structured Hash.
      #
      # @param domain [HecksPlayground::BluebookModel::Structure::Domain] the domain to serialize
      ...
      #
      # @param agg [HecksPlayground::BluebookModel::Structure::Aggregate] the aggregate
      ...
      #
      # @param attr [HecksPlayground::BluebookModel::Structure::Attribute] the attribute
      ...
      #
      # @param cmd [HecksPlayground::BluebookModel::Behavior::Command] the command
      # @param event [HecksPlayground::BluebookModel::Behavior::BluebookEvent, nil] the paired event
      ...
      #
      # @param policy [HecksPlayground::BluebookModel::Behavior::Policy] the policy
      ...
      #
      # @param validation [HecksPlayground::BluebookModel::Structure::Validation] the validation
      ...
      #
      # @param vo [HecksPlayground::BluebookModel::Structure::ValueObject] the value object
      ...
      #
      # @param entity [HecksPlayground::BluebookModel::Structure::Entity] the entity
      ...
      #
      # @param service [HecksPlayground::BluebookModel::Behavior::Service] the service
