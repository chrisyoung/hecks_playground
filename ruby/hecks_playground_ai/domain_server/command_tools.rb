module HecksPlayground
  module MCP
    class DomainServer
      # HecksPlayground::MCP::DomainServer::CommandTools
      #
      ...
      #   - +@domain+ [HecksPlayground::BluebookModel::Structure::Domain] -- the domain model
      ...
      module CommandTools
        ...
        #
        # @param agg [HecksPlayground::BluebookModel::Structure::Aggregate] the aggregate owning the command
        # @param agg_class [Class] the generated Ruby class for the aggregate
        # @param cmd [HecksPlayground::BluebookModel::Behavior::Command] the command to register
        # @return [void]
