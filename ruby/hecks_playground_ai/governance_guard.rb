# HecksPlayground::GovernanceGuard
#
...
#
#   domain = HecksPlayground.domain("Health") { world_concerns :privacy, :consent; ... }
#   result = HecksPlayground::GovernanceGuard.new(domain).check
#   result.passed?      # => false
...
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::AI::GovernanceParagraph,
...
module HecksPlayground
  class GovernanceGuard
    ...
    # @param domain [HecksPlayground::BluebookModel::Structure::Domain] the domain to check
    ...
    #
    # @return [HecksPlayground::GovernanceGuard::Result]
    def check
    ...
    def fetch_ai_suggestions(violations)
      ...
      prompt = "Given these domain governance violations in a HecksPlayground domain model, " \
               "provide 1-3 brief, actionable suggestions:\n\n#{summary}"

      client = HecksPlayground::AI::LlmClient.new(api_key: @api_key)
