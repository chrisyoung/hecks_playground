# HecksPlayground::MCP::GovernanceTools
#
# Thin MCP wrapper around HecksPlayground::GovernanceGuard. Extracts the domain
...
module HecksPlayground
  module MCP
    module GovernanceTools
      ...
      # @param ctx [HecksPlayground::McpServer] shared context with workshop access
      # @return [void]
      def self.register(server, ctx)
        server.define_tool(
          ...
          guard = HecksPlayground::GovernanceGuard.new(domain)
          result = guard.check
