HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::AI::InspectParagraph,
  base_dir: __dir__
)

module HecksPlayground
  module MCP
    # HecksPlayground::MCP::InspectTools
    #
    ...
    #   - +show_dsl+         -- the raw HecksPlayground DSL source that defines the domain
    #
    ...
    module InspectTools
      ...
      # @param ctx [HecksPlayground::McpServer] the shared context providing session access,
