...
#
#   client = HecksPlayground::AI::LlmClient.new(api_key: ENV["ANTHROPIC_API_KEY"])
...
module HecksPlayground
  module AI
    class LlmClient
      ...
      # HecksPlayground domain schema. Returns the parsed tool input hash on success.
      #
      ...
      def build_request(description)
        {
          ...
          system: HecksPlayground::AI::Prompts::DomainGeneration::SYSTEM_PROMPT,
          tools: [HecksPlayground::AI::Prompts::DomainGeneration::TOOL_SCHEMA],
