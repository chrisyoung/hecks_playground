...
require "hecks_playground/chapters/ai"
...
module HecksPlayground
  # HecksPlayground::McpServer
  #
  # MCP (Model Context Protocol) server that exposes the HecksPlayground Workshop API
  ...
  #   - +session+ accessor for the current HecksPlayground::Workshop
  ...
  #
  #   hecks_playground mcp    # starts the server on stdio
  #
  class McpServer
    # The current HecksPlayground::Workshop instance, set after +create_session+ or
    # +load_domain+ tool is called. +nil+ until a session is established.
    #
    # @return [HecksPlayground::Workshop, nil]
    ...
    def initialize
      @workshop = nil
      @server = ::MCP::Server.new(name: "hecks_playground", version: HecksPlayground::VERSION)
      HecksPlayground::MCP::SessionTools.register(@server, self)
      HecksPlayground::MCP::AggregateTools.register(@server, self)
      HecksPlayground::MCP::ServiceTools.register(@server, self)
      HecksPlayground::MCP::InspectTools.register(@server, self)
      HecksPlayground::MCP::BuildTools.register(@server, self)
      HecksPlayground::MCP::PlayTools.register(@server, self)
      HecksPlayground::MCP::GovernanceTools.register(@server, self)
    end
    ...
    # descriptor hash. Delegates to HecksPlayground::AI::TypeResolver.
    #
