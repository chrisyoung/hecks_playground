# HecksPlayground::AI::Prompts::DomainGeneration
#
...
#
#   HecksPlayground::AI::Prompts::DomainGeneration::SYSTEM_PROMPT  # => String
#   HecksPlayground::AI::Prompts::DomainGeneration::TOOL_SCHEMA    # => Hash
#
HecksPlayground::Chapters.load_aggregates(
  HecksPlayground::AI::PromptsParagraph,
  base_dir: __dir__
)
  ...
  module AI
    module Prompts
      module DomainGeneration
        ...
        TOOL_SCHEMA = HecksPlayground::AI::Prompts::DomainToolSchema::SCHEMA
      end
    end
  end
end
