# HecksPlayground::AI::Prompts::DomainToolSchema
#
...
#
#   HecksPlayground::AI::Prompts::DomainToolSchema::SCHEMA  # => Hash
#
  ...
  module AI
    module Prompts
      module DomainToolSchema
        ...
        SCHEMA = {
          name: "define_domain",
          description: "Define a domain model as structured JSON for the HecksPlayground compiler",
          input_schema: {
            type: "object",
