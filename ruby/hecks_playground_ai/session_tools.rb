module HecksPlayground
  module MCP
    # HecksPlayground::MCP::SessionTools
    #
    ...
    module SessionTools
      ...
      # @param ctx [HecksPlayground::McpServer] shared context; +ctx.workshop+ set on invoke
      # @return [void]
      def self.register(server, ctx)
        server.define_tool(
          ...
          ctx.workshop = HecksPlayground.workshop(args["name"])
        ...
        server.define_tool(
          ...
          ctx.capture_output do
            ...
            ctx.workshop = HecksPlayground.workshop(domain.name)
