# HecksPlayground::ArchitectureTour
#
# Interactive CLI walkthrough of the HecksPlayground framework internals for
...
module HecksPlayground
  # HecksPlayground::ArchitectureTour
  #
  # Interactive CLI walkthrough of HecksPlayground internals for contributors, stepping through monorepo layout and pipeline.
  #
  class ArchitectureTour
    # HecksPlayground::ArchitectureTour::Step
    #
    ...
    def start
      puts ""
      puts "=== HecksPlayground Architecture Tour ==="
      ...
      puts ""
      puts "Explore any component with `hecks_playground console`, or run `hecks_playground tour`"
