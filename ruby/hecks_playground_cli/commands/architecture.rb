# HecksPlayground::CLI -- architecture command
#
...
#
#   hecks_playground architecture
#
HecksPlayground::CLI.handle(:architecture) do |inv|
  require "hecks_playground"

  begin
    HecksPlayground.boot(Dir.pwd)
  ...
  unless hecksagon
    say "No hecksagon found. Run from a directory with hecks_playground/*.bluebook files.", :red
    next
  end
