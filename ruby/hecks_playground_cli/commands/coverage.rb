# HecksPlayground::CLI -- coverage command
#
...
#
#   hecks_playground coverage                    # scan current directory
#   hecks_playground coverage --views path/to   # scan specific views directory
#
HecksPlayground::CLI.handle(:coverage) do |inv|
  ...
  scanner = HecksPlayground::Capabilities::ProductExecutor::TagScanner
