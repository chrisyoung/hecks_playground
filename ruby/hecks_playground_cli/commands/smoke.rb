# HecksPlayground::CLI smoke command
#
...
#
#   cd examples/pizzas && hecks_playground smoke
#
HecksPlayground::CLI.handle(:smoke) do |inv|
  require "hecks_playground"

  begin
    runtimes = HecksPlayground.boot(Dir.pwd)
