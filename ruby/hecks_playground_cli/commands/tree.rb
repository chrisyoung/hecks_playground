# HecksPlayground::CLI -- tree command
#
# Prints all registered CLI commands organized by group, showing
# a tree-style overview of the full command surface.
#
#   hecks_playground tree
#   hecks_playground tree --format json
#
HecksPlayground::CLI.handle(:tree) do |inv|
  ...
  say "HecksPlayground CLI Commands", :bold
  say ""
