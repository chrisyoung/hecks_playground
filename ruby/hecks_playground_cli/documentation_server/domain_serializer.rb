# HecksPlayground::CLI::DocumentationServer::DomainSerializer
#
# Walks a domain IR and produces a JSON-ready hash for the browser.
# Reads render_mode, color, icon from HecksPlayground::DomainPresentation —
# the compiled form of nursery/hecks_playground/domain_presentation.bluebook.
#
#   DomainSerializer.new(domain).call
#   # => { name: "Pizzas", aggregates: [...], policies: [...] }
#
require "hecks_playground/domain_presentation"
    ...
    class DocumentationServer
      class DomainSerializer
        ...
        def call
          {
            name: @domain.name,
            expressions: HecksPlayground::DomainPresentation.all,
        ...
        def serialize_aggregate(agg)
          {
            ...
            sections: HecksPlayground::DomainPresentation.express(agg),
