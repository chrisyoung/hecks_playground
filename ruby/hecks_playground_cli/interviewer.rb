...
#
#   interviewer = HecksPlayground::Interviewer.new(ask: method(:ask), say: method(:say))
...
module HecksPlayground
  ...
  class Interviewer
    ...
    def run
      ...
      HecksPlayground::DslSerializer.new(domain).serialize
    end
    ...
    def ask_domain_name
      loop do
        ...
        return HecksPlayground::Utils.sanitize_constant(answer.strip)
      end
    end
    ...
    def ask_aggregates
      ...
      loop do
        ...
        agg_name = HecksPlayground::Utils.sanitize_constant(answer.strip)
    ...
    def build_domain(name, aggregates)
      builder = HecksPlayground::DSL::BluebookBuilder.new(name)
