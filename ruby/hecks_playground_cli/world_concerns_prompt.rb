# HecksPlayground::WorldConcernsPrompt
#
# Interactive onboarding prompt that asks developers to declare world concerns
# for a new domain. Each concern maps to a real HecksPlayground extension that enforces
...
module HecksPlayground
  # HecksPlayground::WorldConcernsPrompt
  #
  # Interactive prompt for declaring world concerns that map to HecksPlayground extensions during domain init.
  #
  class WorldConcernsPrompt
    ...
    def show_welcome
      @say.call("")
      @say.call("Welcome to HecksPlayground.")
      @say.call("")
      @say.call("HecksPlayground is built on the belief that software affects living beings.")
