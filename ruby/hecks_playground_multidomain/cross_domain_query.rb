  # HecksPlayground::CrossDomainQuery
  #
  # A read-only query that spans multiple bounded contexts. Registered at
  # the application level via +HecksPlayground.cross_domain_query+, it resolves
  ...
  # == Registration
  #
  #   HecksPlayground.cross_domain_query "ComplianceCheck" do |model_id:|
  ...
  # == Execution
  #
  #   result = HecksPlayground.query("ComplianceCheck", model_id: "abc")
