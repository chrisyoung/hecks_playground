  # HecksPlayground::CrossDomainView
  #
  ...
  # == Usage
  #
  #   view = HecksPlayground.cross_domain_view "RiskDashboard" do
...
module HecksPlayground
  ...
  class CrossDomainView
    ...
    #
    # @param event_bus [HecksPlayground::EventBus, HecksPlayground::FilteredEventBus, nil] the event bus
