# HecksPlayground::Boot::EventDirectionality
#
...
module HecksPlayground
  module MultiDomain
    ...
    module Directionality
      ...
      #
      # @param domains [Array<HecksPlayground::BluebookModel::Structure::Domain>] all domains in the multi-domain setup
      ...
      # that source.
      #
      # @param domains [Array<HecksPlayground::BluebookModel::Structure::Domain>] all domains
