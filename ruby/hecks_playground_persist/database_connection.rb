# [antibody-exempt: ruby/hecks_playground_persist/database_connection.rb — kernel-floor Sequel bridge for SQL connect. Retires when the storage adapter family ships as a bluebook with provider bindings (:sql_database with :sqlite / :postgres / :mysql sub-adapters).]
module HecksPlayground
  class Configuration
    # HecksPlayground::Configuration::DatabaseConnection
    #
    ...
    module DatabaseConnection
      ...
      def connect_database
        begin
          ...
          raise LoadError,
            "HecksPlayground SQL persistence requires the `sequel` gem. " \
            "Add to your Gemfile :\n\n    gem \"sequel\"\n\n" \
