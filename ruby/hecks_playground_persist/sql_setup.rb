...
module HecksPlayground
  class Configuration
    # HecksPlayground::Configuration::SqlSetup
    #
    ...
    # Mixed into Configuration to provide SQL persistence setup during HecksPlayground.configure.
    #
    module SqlSetup
      ...
      def generate_adapters(domain_obj)
        domain_obj.aggregates.each do |agg|
          ...
          eval(gen.generate, TOPLEVEL_BINDING, "(hecks_playground:sql:#{agg.name})")
        end
      end
    end
  end
