...
module HecksPlayground
  module Migrations
    module Strategies
      ...
      # Output goes to db/hecks_playground_migrate/ to avoid conflicts with ActiveRecord.
      #
      ...
      #
      # @return [String] the file path (e.g., "db/hecks_playground_migrate/20260326120000_hecks_playground_migration.sql")
      def file_path
        timestamp = Time.now.strftime("%Y%m%d%H%M%S")
        "db/hecks_playground_migrate/#{timestamp}_hecks_playground_migration.sql"
      end
