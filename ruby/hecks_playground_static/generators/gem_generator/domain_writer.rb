...
# Reuses hecks_playground_domain generators with mixin_prefix for static output.
#
module HecksStatic
  class GemGenerator < HecksPlayground::Generator
    module DomainWriter
      include HecksTemplating::NamingHelpers

      DomainGen = HecksPlayground::Generators::Domain
      InfraGen  = HecksPlayground::Generators::Infrastructure

      private

      # Resolves a path relative to root through +HecksPlayground::Utils.safe_path!+,
      ...
      def safe_join(root, *parts)
        ...
        HecksPlayground::Utils.safe_path!(root, relative)
      end
