...
fn provider_badge_for(provider: &str) -> &'static str {
    match provider {
        "local" => "🦙",
        // "off" returns empty — Chris removed the 🚫 badge (2026-05-10)
        // because the off-state is visual noise on a working statusline.
        // The render code skips empty badges, so off shows nothing.
        "off"   => "",
