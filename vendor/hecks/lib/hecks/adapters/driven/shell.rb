# Hecks::Adapters::Shell — the execution port's shell implementation.
#
# Vendored addition, not (yet) upstream hecks. Answers Tools::ShellTool
...
#   Hecks::Adapters::Shell.execute("Bash", shell_command: "echo hi")
#   # => { tool: "bash", output: "hi\n", exit_code: 0, ok: true }
#
