# Hecks::Bluebook::{TestSetup,TestCase,BehaviorsSuite}
#
...
# arrive typed.
#
# Deliberately NOT part of `include Hecks::IR`/`emits_ir` — a
# behaviors suite is never collected into the domain Registry (see
# `Hecks.behaviors`, lib/hecks.rb) and never dispatched through
