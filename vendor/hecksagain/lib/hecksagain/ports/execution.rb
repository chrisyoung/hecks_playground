...
# side of this port.
#
# Vendored addition, not (yet) upstream hecksagain. WHY IT EXISTS: the
...
# in hecksagain's own idiom — a `.port` with a verb, `.adapter`s declaring
...
# has no implementation anywhere in hecksagain — HecksagonBuilder#success /
    ...
    module Execution
      ...
      def adapter_for(bind)
        ...
        raise Runtime::WiringError,
              ...
              "(expected Hecksagain::Adapters::#{bind.adapter})"
      end
